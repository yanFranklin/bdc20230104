 ...
 */
public class SdkApiDzzzZzqzApp extends SdkApiDzzzZzqzTokenApp {

    @Override
    public ApiRequest getRequest() {
        ApiRequest apiRequest = new ApiRequest(HttpConstant.SCHEME_HTTP, Method.POST, "/2.0/zzwk-service/criterion/makeSignCertificate", SdkConstant.AUTH_TYPE_ENCRYPT, "1");
        return apiRequest;
    }
}
