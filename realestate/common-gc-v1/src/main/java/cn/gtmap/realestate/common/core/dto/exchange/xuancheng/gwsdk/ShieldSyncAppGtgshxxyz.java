 ...
 * 个体工商户基本信息查询验证
 */
public class ShieldSyncAppGtgshxxyz extends BaseApp {

    public ShieldSyncAppGtgshxxyz() {
        this.apiClient = new ApiClient();
        this.apiClient.init();
        this.appId = "3192e7b1e638465c83132ce05166429c";
        this.appSecret = "9F72F15418104EDA9A71FE0C02D49F7F";
        ...
        this.publicKey = "305C300D06092A864886F70D0101010500034B0030480241009546339441FD759A08530C50E18BD414277B56C3466EE64D5BC04932C286DB033723361C7099F37E1124C608509CCD1F1ADE75235D0CACBF26A6F2E56F6B9A990203010001";
    }
     ...
     */
    public ApiResponse Gtgsjbxxyz(String epbno, String name, String traname, String authcode) {
        ApiRequest apiRequest = new ApiRequest(
                HttpConstant.SCHEME_HTTP,
                Method.POST,
                "/api/DEF106627EA04010B907955A75E5336B",
