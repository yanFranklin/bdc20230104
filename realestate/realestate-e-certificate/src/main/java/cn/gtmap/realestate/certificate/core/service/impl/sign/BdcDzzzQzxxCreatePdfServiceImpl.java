 ...
 */
public class BdcDzzzQzxxCreatePdfServiceImpl implements BdcDzqzValidateService {
    ...
    public Map<String, Object> validate(DzzzValidate dzzzValidate) {
        ...
        if (null != bdcDzzzZzxx && StringUtils.isNotEmpty(bdcDzzzZzxx.getYwh()) && StringUtils.isNotEmpty(bdcDzzzZzxx.getBdcqzh())) {
            ...
            //此处不进行验证非正常注销的证书
            List<BdcDzzzZzxxDO> bdcDzzzZzxxDOList = bdcDzzzDzqzMapper.getBdcDzzzZzxxDoByMap(paramMap);
