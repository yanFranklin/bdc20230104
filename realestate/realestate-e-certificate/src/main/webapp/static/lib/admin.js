...
;layui.define("view", function (e) {
    var a = layui.jquery, i = layui.laytpl, t = layui.element, n = layui.setter, s = layui.view, l = layui.device(), o = a(window), r = a("body"), d = a("#" + n.container), u = "layui-show", c = "layui-this", y = "layui-disabled", f = "#LAY_app_body", m = "LAY_app_flexible", h = "layadmin-layout-tabs", p = "layadmin-side-spread-sm", v = "layadmin-tabsbody-item", b = "layui-icon-shrink-right", g = "layui-icon-spread-left", x = "layadmin-side-shrink", C = "LAY-system-side-menu", P = {
        ...
        closeThisTabs: function () {
            P.tabsPage.index != 1 && P.tabsPage.index && a(_).eq(P.tabsPage.index).find(".layui-tab-close").trigger("click")
        }
    }, A = P.events = {
        flexible: function (e) {
            ...
            "all" === e ? (a(_ + ":gt(0)").remove(), a(f).find("." + v + ":gt(0)").remove(), a(_).eq(0).trigger("click")) : (a(_).each(function (e, t) {
                e && e != 1 && e != P.tabsPage.index && (a(t).addClass(i), P.tabsBody(e).addClass(i))
            }), a("." + i).remove())
        }, closeAllTabs: function (e) {
            var i = "LAY-system-pagetabs-remove";
            "all" === e ? (a(_ + ":gt(0)").remove(), a(f).find("." + v + ":gt(0)").remove(), a(_).eq(0).trigger("click")) : (a(_).each(function (e, t) {
                e && e != 1 && (a(t).addClass(i), P.tabsBody(e).addClass(i));
                if(e == 1){
                    a(t).click();
                }
            }), a("." + i).remove())
    ...
    !function () {
        ...
        e.theme && P.theme(e.theme), l.ie && l.ie < 9 && s.error("IE" + l.ie + "下访问可能不佳，推荐使用：Chrome / Firefox / Edge 等高级浏览器", {
            offset: "auto",
            id: "LAY_errorIE"
        })
