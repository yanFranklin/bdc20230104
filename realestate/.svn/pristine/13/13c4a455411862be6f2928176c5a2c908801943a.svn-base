...
import cn.gtmap.realestate.common.core.service.feign.natural.ZrzyXtJgFeignService;
import cn.gtmap.realestate.common.core.service.feign.natural.ZrzyXtJgpzFeignService;
...
public class ZrzyXtJgpzController extends BaseController {
    @Autowired
    private ZrzyXtJgpzFeignService zrzyXtJgpzFeignService;

    @Autowired
    private ZrzyXtJgFeignService zrzyXtJgFeignService;
    ...
    public BdcXtJgDO saveJgpz(@RequestBody BdcXtJgDO bdcXtJgDO) {
        return zrzyXtJgpzFeignService.saveJgpz(bdcXtJgDO);
    }
    ...
    public BdcXtJgDO saveJgpz(String jgid) {
        return zrzyXtJgpzFeignService.queryJgpz(jgid);
    }
    ...
    public void deleteJgpz(@RequestParam("jgidList") List<String> jgidList) {
        zrzyXtJgpzFeignService.deleteJgpz(jgidList);
    }
    ...
    public Object importXtjgToExcel(MultipartHttpServletRequest httpServletRequest) {
        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                count += zrzyXtJgpzFeignService.saveJgpzPl(bdcXtJgDOList);
            }
    ...
    public List<BdcXtJgDO> queryAllJg() {
        return zrzyXtJgFeignService.listBdcXtJg(1);
    }
    ...
    public Object queryLzrByPage(@LayuiPageable Pageable pageable, BdcXtjgLzrQO bdcXtjgLzrQO) {
        return addLayUiCode(zrzyXtJgFeignService.queryJgLzrByPage(pageable, JSON.toJSONString(bdcXtjgLzrQO)));
    }
    ...
    public void deleteLzr(@PathVariable("gxid") String gxid) {
        zrzyXtJgFeignService.deleteJglzr(gxid);
    }
    ...
    public void deleteLzr(@RequestBody BdcJgLzrGxDO bdcJgLzrGxDO) {
        zrzyXtJgFeignService.insertBdcJgLzr(bdcJgLzrGxDO);
    }
}
