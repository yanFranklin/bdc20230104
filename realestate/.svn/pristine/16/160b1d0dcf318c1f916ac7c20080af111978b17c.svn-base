...
layui.use(['jquery', 'form', 'layer'], function () {
    ...
    $(function () {
        ...
        form.on("submit(prev)", function () {
            window.location.href = getContextPath() + "/view/xxbl/lc_home.html?processInsId=" + processInsId + "&type=" + type + "&taskId=" + taskId + "&ygzlslid=" + ygzlslid;
        });
        ...
        function judgeZslx(zslx){
            ...
            switch (zslx) {
                case 'zs':
                    url = getContextPath() + "/view/xxbl/lc_zs.html?xmid=" + xmid + "&qllx=" + qllx + "&bdcdyfwlx=" + bdcdyfwlx + "&processInsId=" + processInsId + "&type=" + type + "&taskId=" + taskId + "&ygzlslid=" + ygzlslid;
                    break;
                case 'zm':
                    url = getContextPath() + "/view/xxbl/lc_zm.html?xmid=" + xmid + "&qllx=" + qllx + "&bdcdyfwlx=" + bdcdyfwlx + "&processInsId=" + processInsId + "&type=" + type + "&taskId=" + taskId + "&ygzlslid=" + ygzlslid;
                    break;
                case 'list':
                    url = getContextPath() + "/view/xxbl/lc_zsList.html?xmid=" + xmid + "&qllx=" + qllx + "&bdcdyfwlx=" + bdcdyfwlx + "&processInsId=" + processInsId + "&type=" + type + "&taskId=" + taskId + "&ygzlslid=" + ygzlslid;
                    break;
                case 'no':
                    url = '';
                    break;
