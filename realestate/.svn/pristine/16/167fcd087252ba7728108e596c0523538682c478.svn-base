...
layui.use(['jquery', 'layer', 'element', 'form', 'table', 'laytpl'], function () {
    ...
    $(function () {
        ...
        $(document).on('click', '.getJtcyxx', function () {
            ...
            getReturnData("/slym/jtcy/hefei/getJtcyxx",{qlrmc:qlrmc,qlrzjh:qlrzjh,sqrid:sqrid,slbh:slbh},"GET",function (data) {
                loadYcslxx();
        ...
        for(var i = 0; i < list.length; i++){
            ...
            for(var j = 0; j < list[1-i].poJtcyList.length; j++){
                ...
                for(var k = 0; k < jtcyList.length; k++){
                    ...
                    // || poJtcy.jtcymc === list[i].bdcSlSqrDO.sqrmc
                        isExistJtcy=true;
                        break;
                    }
                }
