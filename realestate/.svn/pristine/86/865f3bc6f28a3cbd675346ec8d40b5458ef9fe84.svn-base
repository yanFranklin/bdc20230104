...
public class DjfDjSfOldDO implements Serializable, AccessData {
    ...
    private String jfzt;
    @ApiModelProperty(value = "交款业务类型:1-所有权，2-抵押权")
    private String jkywlx;
    @ApiModelProperty(value = "非税缴款码")
    private String fsjkm;
    @ApiModelProperty(value = "非税电子单号")
    private String fsdzph;
    ...
    public String getJkywlx() {
        return jkywlx;
    }

    public void setJkywlx(String jkywlx) {
        this.jkywlx = jkywlx;
    }
    ...
    public void setFsjkm(String fsjkm) {
        this.fsjkm = fsjkm;
    }

    public String getFsdzph() {
        return fsdzph;
    }

    public void setFsdzph(String fsdzph) {
        this.fsdzph = fsdzph;
    }
}
