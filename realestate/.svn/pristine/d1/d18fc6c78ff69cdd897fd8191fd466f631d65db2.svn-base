...
public class BengbuZwSdkAPi extends BaseApp {
    ...
    public ApiResponse apasRegInfo(String apasRegInfo, String attrXml, String formXml) {
        ApiRequest apiRequest = new ApiRequest(HttpConstant.SCHEME_HTTP, Method.POST, "/api/apasRegInfo", SdkConstant.AUTH_TYPE_DEFAULT, SignType.DEFAULT.name(), "0d21a399f1c74800b10ea64b271e9a62");
//        initSignStrategy(apiRequest);
    ...
    public void projIdFeedback(String projIdFeedbackXml, ApiCallback apiCallback) {
        ApiRequest apiRequest = new ApiRequest(HttpConstant.SCHEME_HTTP, Method.POST, "/1.0/djz-tylsh-rest/api/projIdFeedback", SdkConstant.AUTH_TYPE_ENCRYPT, SignType.DEFAULT.name(), "1");
        //initSignStrategy(apiRequest);
