 ...
 * @description 不动产查封查询实现服务
 */
@Service("bdcCfServiceImpl")
public class BdcCfServiceImpl implements BdcXzQlService {
    ...
    public Set<String> getInterfaceCode() {
        ...
        set.add(BdcCfDO.class.getSimpleName());
        set.add("98");
        return set;
    }
     ...
     * @return List<BdcCfDO>
     * @author <a href="mailto:zhangwentao@gtmap.cn">zhangwentao</a>
     * @description 获取当前单元的查封登记，并按照djsj升序排序
     */
    @Override
    ...
    public List<BdcQl> queryListBdcZxQl(String bdcdyh) {
        ...
        if (StringUtils.isNotBlank(bdcdyh)) {
            bdcZxQlList = repo.selectList("listBdcZxCf",bdcdyh);
        }
        return bdcZxQlList;
    }
    ...
    public BdcQlNumDTO countBdcQl(BdcQlNumDTO bdcQlNumDTO, String bdcdyh, List qsztList) {
        if (StringUtils.isNotBlank(bdcdyh)) {
            ...
            bdcQlNumDTO.setCfNum(entityMapper.countByExample(BdcCfDO.class, example));
        }
        return bdcQlNumDTO;
    }
     ...
     * @param bdcZxQO   注销登簿人
     * @author <a href="mailto:zhangwentao@gtmap.cn">zhangwentao</a>
     * @description 更新查封注销信息
     */
    @Override
    public int updateZxDbxx(BdcQl bdcQl, BdcZxQO bdcZxQO) {
        if (bdcQl instanceof BdcCfDO) {
            BdcCfDO bdcCfDO = (BdcCfDO) bdcQl;
            bdcCfDO.setQszt(bdcZxQO.getQszt());
            bdcCfDO.setJfdbr(bdcZxQO.getZxdbr());
            bdcCfDO.setJfdjsj(bdcZxQO.getZxdjsj());
            bdcCfDO.setJfywh(bdcZxQO.getZxywh());
            bdcCfDO.setJfyy(bdcZxQO.getZxyy());
            return entityMapper.updateByPrimaryKeyNull(bdcCfDO);
        }
        return -1;
    }
    ...
    public BdcDjbQlDTO judgeDjbXzQl(BdcDjbQlDTO bdcDjbQlDTO, String bdcdyh, List<Integer> qsztList) {
        ...
        if (bdcQlNumDTO.getCfNum() > 0) {
            bdcDjbQlDTO.setCf("cf");
        }
        return bdcDjbQlDTO;
    }
    ...
    public Page<BdcQl> bdcQlByPageJson(Map<String, Object> map, Pageable pageable) {
        return repo.selectPaging("listBdcCfByPage", map, pageable);
    }
    ...
    public int updateQlGyqkPl(BdcGyqkDTO bdcGyqkDTO) {
        ...
        return bdcCfMapper.updateQlGyqkPl(bdcGyqkDTO);
    }
    ...
    public int udpateBdcQlDbxxAndQsztPl(DbxxQO dbxxQO) {
        ...
        return bdcCfMapper.udpateBdcQlDbxxAndQsztPl(dbxxQO);
    }
    ...
    public int udpateYqlZxDbxxAndQsztPl(DbxxQO dbxxQO) {
        ...
        return bdcCfMapper.udpateBdcQlZxDbxxAndQsztPl(dbxxQO);
    }
    ...
    public int updateBdcQlQsztPl(DbxxQO dbxxQO) {
        ...
        return bdcCfMapper.udpateBdcCfQsztPl(dbxxQO);
    }
     ...
     */
    public int updateCfjgOrJfjg(BdcCfjgQO bdcCfjgQO) {
        if (StringUtils.isBlank(bdcCfjgQO.getGzlslid())) {
            throw new MissingArgumentException("缺失工作流实例ID！");
        }
        if (bdcCfjgQO.isIscf()) {
            return bdcCfMapper.updateCfjgAndBzxr(bdcCfjgQO);
        }
        if (bdcCfjgQO.isIsjf()) {
            return bdcCfMapper.updateJfjg(bdcCfjgQO);
        }
        return -1;
    }
     ...
     * @description 根据xmid集合查询查封信息
     * @date : 2021/8/19 16:55
     */
    public List<BdcCfDO> listBdcCfxx(BdcCfQO bdcCfQO) {
        if (Objects.nonNull(bdcCfQO) && CollectionUtils.isNotEmpty(bdcCfQO.getXmid())) {
            return bdcCfMapper.listBdcCfxx(bdcCfQO);
        }
    ...
    public BdcSyqxDTO generateQlSyqx(BdcQl bdcQl){
        ...
        if(bdcQl instanceof BdcCfDO){
            ...
            if(bdcCfDO.getCfqssj() != null){
                syqx =sdf.format(bdcCfDO.getCfqssj()) +CommonConstantUtils.QI;
            }
            if(bdcCfDO.getCfjssj() !=null){
                syqx +=sdf.format(bdcCfDO.getCfjssj()) +CommonConstantUtils.ZHI;
            }
        }
    ...
    public BdcSyqxDTO generateQlSyqxPl(JSONObject jsonObject){
        if(jsonObject.containsKey("cfqssj") &&jsonObject.containsKey("cfjssj")) {
            BdcSyqxDTO bdcSyqxDTO = new BdcSyqxDTO();
            bdcSyqxDTO.setUpdate(true);
            String syqx = StringUtils.EMPTY;
            SimpleDateFormat sdf = new SimpleDateFormat("yyyy年MM月dd日");
            if (jsonObject.getDate("cfqssj") != null) {
                syqx = sdf.format(jsonObject.getDate("cfqssj")) + CommonConstantUtils.QI;
            }
            if (jsonObject.getDate("cfjssj") != null) {
                syqx += sdf.format(jsonObject.getDate("cfjssj")) + CommonConstantUtils.ZHI;
            }
            bdcSyqxDTO.setSyqx(syqx);
            return bdcSyqxDTO;
        }
    ...
    public int updateBdcQlDbrPl(DbxxQO dbxxQO){
        ...
        return bdcCfMapper.updateBdcQlDbrPl(dbxxQO);
    ...
    public int updateZxQlDbrPl(DbxxQO dbxxQO){
        ...
        return bdcCfMapper.updateZxQlDbrPl(dbxxQO);
