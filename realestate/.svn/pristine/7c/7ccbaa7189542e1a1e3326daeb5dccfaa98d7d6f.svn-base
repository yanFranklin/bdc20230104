 ...
 * @version 1.0
 * @description 不动产代码转为第三方字典项，如果第三方对照表中没有，则返会原值即可
 */
public class BdcDmToDsfZdOriginalValueCustomConvert implements GtmapCompareableCustomConverter {

    private String parameter;

    private static final Logger LOGGER = LoggerFactory.getLogger(BdcDmToDsfZdOriginalValueCustomConvert.class);
