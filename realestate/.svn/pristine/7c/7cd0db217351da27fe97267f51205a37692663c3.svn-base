...
layui.use(['table','laytpl','laydate','layer', 'form'],function () {
    ...
    table.render({
        ...
        url: "/realestate-inquiry-ui/rest/v1.0/fph/page",
        request: {
        ...
        cols: [[
            ...
            {minWidth:80, sort:false, templet:'#barAction', title:'操作', fixed: 'right'}
        ]],
        text: {
            none: '未查询到数据'
        },
    ...
    function saveSyqk(index, data) {
        ...
        $.ajax({
            url: "/realestate-inquiry-ui/rest/v1.0/fph/syqkedit",
            type: "POST",
    ...
    function deleteFph(data){
        ...
        var deleteIndex = layer.open({
            ...
            yes: function(){
                $.ajax({
                    url: "/realestate-inquiry-ui/rest/v1.0/fph",
                    type: "DELETE",
