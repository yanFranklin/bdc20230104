 ...
 * @description 执行静态方法
 */
public class ExecuteStaticMethodObjCustomConvert implements GtmapCompareableCustomConverter {
    ...
    public Object convert(Object existingDestinationFieldValue, Object sourceFieldValue, Class<?> destinationClass, Class<?> sourceClass) {
        if(StringUtils.isNotBlank(param)){
            ...
            if(params != null &&params.length >0) {
                String fun = params[0];
                if(params.length >1 &&StringUtils.equals("this",params[1])){
                    return CommonUtil.executeStaticMethod(fun, srcObject);
                }else{
                    return CommonUtil.executeStaticMethod(fun, sourceFieldValue);
                }
            }
        }
        return null;
