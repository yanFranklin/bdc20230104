 ...
 * @description 拼接字符串 分隔符为英文句号
 */

public class ConnectFieldWithYwJhCustomConvert implements GtmapCompareableCustomConverter {
            ...
            try {
                for(String s:str){
                    ...
                    if (get.invoke(srcObject) != null) {
                        builder.append(get.invoke(srcObject).toString()+CommonConstantUtils.ZF_YW_JH) ;
                    }
                }
                if(builder.length()> 0){
