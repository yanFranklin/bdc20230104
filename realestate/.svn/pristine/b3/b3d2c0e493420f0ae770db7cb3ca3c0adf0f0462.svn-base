                    ...
                    <div class="basic-info">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline margin-top-ipt">
                                ...
                                <div class="layui-input-inline bdc-label-newline">
                            ...
                            <div class="layui-inline margin-top-ipt">
                                <label class="layui-form-label change-label-width bdc-label-newline">参与分摊土地面积计算</label>
                                <div class="layui-input-inline">
...
<script src="../js/fwychs/fwychsForm.js"></script>
</html>