 ...
 * @description 从权籍加载数据到其他相关权利
 */
@Service
public class InitLpbToBdcQtxgqlServiceImpl extends InitBdcQtxgqlAbstractService{
    /**
     * @return 对照开关值
     * @author <a href="mailto:yanzhenkun@gtmap.cn">yanzhenkun</a>
     * @description
    ...
    public BdcQl initQlxx(InitServiceQO initServiceQO) throws Exception {
        return initFromLpbXm(initServiceQO,BdcQtxgqlDO.class,null);
    }
}
