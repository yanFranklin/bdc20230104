...
import cn.gtmap.realestate.common.core.service.rest.natural.ZrzyXtJgpzRestService;
...
@RestController
@Api(tags = "机构配置")
public class ZrzyXtJgpzRestController implements ZrzyXtJgpzRestService {
    @Autowired
    ...
    public int saveJgpzPl(@RequestBody List<BdcXtJgDO> bdcXtJgDOList) {
        ...
        return entityMapper.insertBatchSelective(bdcXtJgDOList);
    }
}
