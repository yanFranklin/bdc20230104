    ...
    $(function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: 'zdzhmj', title: '宗地面积（㎡）', minWidth: 80,
                    templet: function (d) {
                        if(d && d.zdsylx && (d.zdsylx == 2 || d.zdsylx == "2") && d.zdzhmj) {
                            return "共有" + d.zdzhmj;
                        } else {
                            if(d.zdzhmj) {
                                return d.zdzhmj;
                ...
                {field: 'dzwmj', title: '定着物面积（㎡）', minWidth: 80},
        ...
        function exportExcel(cols) {
            ...
            for (var index in cols) {
                if (cols[index].hide == false && cols[index].type != 'checkbox' && !cols[index].toolbar) {
                    if(cols[index].field == "zdzhmj") {
                        exportCol[cols[index].title] = 'zdzhmjmc';
                    } else {
