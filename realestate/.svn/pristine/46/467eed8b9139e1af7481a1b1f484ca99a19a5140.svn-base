...
import cn.gtmap.realestate.common.core.service.rest.refleshconfig.AcceptAppRefleshConfigRestService;
 ...
 * @version: 2022/11/08/18:42
 * @Description:
 */
@RestController
public class RefleshConfigRestController implements AcceptAppRefleshConfigRestService {
    @Autowired
