    ...
    $(function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {title: '查看', fixed: 'right', toolbar: '#barDemoForBengbu', width: 180}
            ]],
            data: [],
            page: true,
        ...
        // 打印有房无房证明
        function printFczm(qlrmc, qlrzjh) {
            $.ajax({
                ...
                success: function (key) {
                    if (key) {
                        ...
                        savePrintInfo(fczmDymb, dataUrl, {'zmbh': key, "printType": "有房无房证明"});
                    } else {
                        failMsg("打印失败，请重试！");
                    }
                },
        ...
        function search() {
            ...
            // };
            //
            // mhlx.bdcdyhmhlx=$("#bdcqzhmh").val();
            // mhlx.zsyzhmhlx=$("#zsyzhmh").val();
            // mhlx.zlmhlx=$("#zlmh").val();
            // mhlx.qlrmcmhlx=$("#qlrmcmh").val();
            // mhlx.qlrzjhmhlx=$("#qlrzjhmh").val();
            // mhlx.ywrmcmhlx=$("#ywrmcmh").val();
            //
