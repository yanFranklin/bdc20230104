...
layui.use(['jquery', 'element', 'form', 'table', 'laydate'], function () {
    ...
    $(function () {
                ...
                success: function (data) {
                    ...
                    if (data && data.length > 0) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            getData.cxywcs.push({"qlrmc": data[i].qlrmc, "zjh": data[i].zjh});
                        }
        ...
        function generateSearchCondition(searchData) {
            $('#name').val(searchData.cxywcs[0].qlrmc);
            $('#tyshxydm').val(searchData.cxywcs[0].zjh);
        ...
        form.on('select(name-select)', function (data) {
            ...
            $(this).parents('.layui-form-item').find('input[name="tyshxydm"]').val(currentDm);
