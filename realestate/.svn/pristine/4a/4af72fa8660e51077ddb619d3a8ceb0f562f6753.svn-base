...
function loadButtonArea(ymlx) {
    $.ajax({
        url: '/realestate-register-ui/rest/v1.0/shxx/shxxBtn',
        type: "GET",
        ...
        success: function (data) {
            if (data) {
                ...
                var json = {
                    lclx: data.lclx,
                    shxxBtn: data.shxxBtn,
                    shxxSplit: data.shxxSplit,
                    zhajlc: data.zhajlc
                }
...
function printSpb(dylx, djxl) {
    if (dylx === "bdcSqSpb") {
        $.ajax({
            type: "GET",
            url: "/realestate-register-ui/rest/v1.0/print/dypz/dylx",
            data: {gzlslid: gzlslid, djxl: djxl, dylx: dylx},
            async: false,
            success: function (data) {
                dylx = data;
            }, error: function (e) {
    ...
    var dataUrl = getIP() + "/realestate-register-ui/rest/v1.0/print/spb/" + gzlslid + "/" + dylx + "/xml?zxlc=" + zxlc + "&sjclIdsStr=" + sjclIdsStr + "&lcpzdylx=true";
