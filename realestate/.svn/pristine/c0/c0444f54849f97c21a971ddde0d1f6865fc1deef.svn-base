 ...
 * 加载领证人信息
 */
function loadLzrxx(xmid, djxl,id,index,tabQllx) {
...
function loadYjxx(){
    ...
    console.log(djxl);
    var slbh = $('#sjbh').val();
    var url = getContextPath() + "/xuancheng/slym/yjxx.html?processInsId=" + processInsId + "&djxl=" + djxl + "&slbh=" + slbh + "&xmid=" +xmid + "&xmidList=" + tabXmidList.toString() +"&lclx=plzh";
    layer.open({
        type: 2,
        area: ['960px', '300px'],
        fixed: false, //不固定
