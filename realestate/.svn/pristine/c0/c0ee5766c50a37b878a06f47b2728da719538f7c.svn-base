...
import cn.gtmap.realestate.register.core.mapper.BdcGjzwsyqMapper;
 ...
 * @description 房屋构筑物所有权
 */
@Service
public class BdcGjzwsyqServiceImpl implements BdcQlService {
    @Autowired
    EntityMapper entityMapper;
    @Autowired
    Repo repo;
    @Autowired
    BdcGjzwsyqMapper bdcGjzwsyqMapper;
    ...
    public Set<String> getInterfaceCode() {
        ...
        set.add(BdcGjzwsyqDO.class.getSimpleName());
        set.add("16");
        set.add("18");
        set.add("24");
        set.add("25");
     ...
     * @param bdcZxQO 注销信息
     * @author <a href="mailto:zhangwentao@gtmap.cn">zhangwentao</a>
     * @description 更新BdcGjzwsyqDO注销登簿信息
     */
    @Override
    public int updateZxDbxx(BdcQl bdcQl, BdcZxQO bdcZxQO) {
        if (bdcQl instanceof BdcGjzwsyqDO) {
            ...
            bdcGjzwsyqDO.setQszt(bdcZxQO.getQszt());
            bdcGjzwsyqDO.setZxdbr(bdcZxQO.getZxdbr());
            bdcGjzwsyqDO.setZxdjsj(bdcZxQO.getZxdjsj());
            bdcGjzwsyqDO.setZxywh(bdcZxQO.getZxywh());
            bdcGjzwsyqDO.setZxyy(bdcZxQO.getZxyy());
            return entityMapper.updateByPrimaryKeyNull(bdcGjzwsyqDO);
        }
        return -1;
    }
    ...
    public List<BdcQl> queryListBdcQl(String bdcdyh, List qsztList) {
        if (StringUtils.isNotBlank(bdcdyh)) {
            Example example = new Example(BdcGjzwsyqDO.class);
    ...
    public List<BdcQl> queryListBdcZxQl(String bdcdyh) {
        ...
        if (StringUtils.isNotBlank(bdcdyh)) {
            bdcZxQlList = repo.selectList("listBdcZxGjzwsyq",bdcdyh);
        }
        return bdcZxQlList;
    }
    ...
    public BdcQlNumDTO countBdcQl(BdcQlNumDTO bdcQlNumDTO, String bdcdyh, List qsztList) {
        if (StringUtils.isNotBlank(bdcdyh)) {
            ...
            bdcQlNumDTO.setCqNum(entityMapper.countByExample(BdcGjzwsyqDO.class, example));
        }
        return bdcQlNumDTO;
    }
    ...
    public Page<BdcQl> bdcQlByPageJson(Map<String, Object> map, Pageable pageable) {
        ...
        return repo.selectPaging("listBdcGjzwsyqByPage", map, pageable);
    }
    ...
    public int updateQlGyqkPl(BdcGyqkDTO bdcGyqkDTO) {
        ...
        return bdcGjzwsyqMapper.updateQlGyqkPl(bdcGyqkDTO);
    }
    ...
    public int udpateBdcQlDbxxAndQsztPl(DbxxQO dbxxQO) {
        return bdcGjzwsyqMapper.udpateBdcQlDbxxAndQsztPl(dbxxQO);
    }
    ...
    public int udpateYqlZxDbxxAndQsztPl(DbxxQO dbxxQO) {
        return bdcGjzwsyqMapper.udpateBdcQlZxDbxxAndQsztPl(dbxxQO);
    }
    ...
    public int updateBdcQlQsztPl(DbxxQO dbxxQO) {
        ...
        return bdcGjzwsyqMapper.udpateBdcGjzwsyqQsztPl(dbxxQO);
    }
    ...
    public BdcSyqxDTO generateQlSyqx(BdcQl bdcQl){
        ...
        if(bdcQl instanceof BdcGjzwsyqDO){
            ...
            if(bdcGjzwsyqDO.getTdhysyqssj() != null){
                syqx =sdf.format(bdcGjzwsyqDO.getTdhysyqssj()) +CommonConstantUtils.QI;
            }
            if(bdcGjzwsyqDO.getTdhysyjssj() !=null){
                syqx +=sdf.format(bdcGjzwsyqDO.getTdhysyjssj()) +CommonConstantUtils.ZHI;
            }
        }
    ...
    public BdcSyqxDTO generateQlSyqxPl(JSONObject jsonObject){
        if(jsonObject.containsKey("tdhysyqssj") &&jsonObject.containsKey("tdhysyjssj")) {
            BdcSyqxDTO bdcSyqxDTO = new BdcSyqxDTO();
            bdcSyqxDTO.setUpdate(true);
            String syqx = StringUtils.EMPTY;
            SimpleDateFormat sdf = new SimpleDateFormat("yyyy年MM月dd日");
            if (jsonObject.getDate("tdhysyqssj") != null) {
                syqx = sdf.format(jsonObject.getDate("tdhysyqssj")) + CommonConstantUtils.QI;
            }
            if (jsonObject.getDate("tdhysyjssj") != null) {
                syqx += sdf.format(jsonObject.getDate("tdhysyjssj")) + CommonConstantUtils.ZHI;
            }
            bdcSyqxDTO.setSyqx(syqx);
            return bdcSyqxDTO;
        }
    ...
    public int updateBdcQlDbrPl(DbxxQO dbxxQO){
        ...
        return bdcGjzwsyqMapper.updateBdcQlDbrPl(dbxxQO);
    ...
    public int updateZxQlDbrPl(DbxxQO dbxxQO){
        ...
        return bdcGjzwsyqMapper.updateZxQlDbrPl(dbxxQO);
