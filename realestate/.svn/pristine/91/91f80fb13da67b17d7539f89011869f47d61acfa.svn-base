...
layui.use(['jquery', 'element', 'form', 'table', 'laydate', 'layer'], function () {
    ...
    $(function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: 'slbh', title: '受理编号', minWidth: 160},
                {field: 'zrzydjdyh', title: '自然资源登记单元号', minWidth: 80},
                {field: 'zl', title: '坐落', minWidth: 80},
                {field: 'djyy', title: '登记原因', minWidth: 80},
                {field: 'slsj', title: '受理时间', minWidth: 150},
                {field: 'jssj', title: '结束时间', minWidth: 250},
                {field: 'dbr', title: '登簿人', minWidth: 200},
                {field: 'zrzycqzh', title: '自然资源产权证号', minWidth: 250},
                {field: 'djdymc', title: '登记单元名称', minWidth: 250},
        ...
        function search() {
            ...
            addModel();
            // 重新请求
            table.reload("zsTableId", {
                url: "/realestate-natural-ui/rest/v1.0/xm/list",
                // method:'POST',
                where: obj
                , page: {
                    curr: 1, //重新从第 1 页开始
        ...
        // 监听表格操作栏按钮
        table.on('toolbar(zsTable)', function (obj) {
    ...
    function checkZrzyData(checkData) {
        ...
        gzyzCommon(1,bdcGzYzQO,function (){
            ...
            setTimeout(function () {
                try {
                    $.when(cshYxm(checkData)).done(function () {
                        removeModal();
    ...
    function cshYxm(checkData) {
        ...
        for (var i = 0; i < checkData.length; i++) {
            ...
            zrzyCshYwxxDTO.yxmid = selectData.xmid;
