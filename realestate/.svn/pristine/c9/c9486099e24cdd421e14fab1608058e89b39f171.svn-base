            ...
            if(data instanceof Array) {
                data.forEach(function (item, index) {
                    ...
                    selectedSvg = '<svg xmlns="http://www.w3.org/2000/svg" width="' + width +'" height="'+ height+'">' +
                        ...
                        '<div xmlns="http://www.w3.org/1999/xhtml" style="font-size:12px; background-color: '+ nodesImageAttr.color.selectedColor.backgroundColor+'; padding: 8px" >坐落：'+item.zl +'</div>' +
                        '<div xmlns="http://www.w3.org/1999/xhtml" style="font-size:12px; padding: 6px 10px 16px 0;  color: #fff">不动产单元号：'+item.bdcdyh +'</div>' +
                        '</foreignObject>' +
                        '</svg>';
                    ...
                    if(index ==0) {
                        unselectedSvg = '<svg xmlns="http://www.w3.org/2000/svg" width="'+ width +'" height="'+height +'">' +
                            ...
                            '<foreignObject x="10" y="10" width="'+(width-20) +'" height="'+ height+'">' +
                            '<div xmlns="http://www.w3.org/1999/xhtml" style="font-size:12px; background-color: '+nodesImageAttr.color.unselectedColor.nowColor.backgroundColor+'; padding: 8px" >坐落：'+item.zl +'</div>' +
                            '<div xmlns="http://www.w3.org/1999/xhtml" style="font-size:12px; padding: 6px 10px 16px 0;">不动产单元号：'+item.bdcdyh +'</div>' +
                            '</foreignObject>' +
                            '</svg>';
                    } else {
                        unselectedSvg = '<svg xmlns="http://www.w3.org/2000/svg" width="'+ width+'" height="'+ height+'">' +
                            ...
                            '<foreignObject x="10" y="10" width="'+ (width-20)+'" height="'+ height+'">' +
                            '<div xmlns="http://www.w3.org/1999/xhtml" style="font-size:12px; background-color: '+nodesImageAttr.color.unselectedColor.preColor.backgroundColor +'; padding: 8px;" >坐落：'+item.zl +'</div>' +
                            '<div xmlns="http://www.w3.org/1999/xhtml" style="font-size:12px; padding: 6px 10px 16px 0; ">不动产单元号：'+item.bdcdyh +'</div>' +
                            '</foreignObject>' +
                            '</svg>';
                    }
