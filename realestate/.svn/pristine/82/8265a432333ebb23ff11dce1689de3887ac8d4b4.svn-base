...
import cn.gtmap.realestate.common.core.service.rest.refleshconfig.CertificateAppRefleshConfigRestService;
 ...
 * @version: 2022/11/15/14:31
 * @Description:
 */
public class RefleshConfigRestController implements CertificateAppRefleshConfigRestService {
    @Autowired
