...
public class QszdDjdcbResponseDTO extends DjDcbResponseDTO {
     ...
     * 权属宗地宗地面积
     */
    @ApiModelProperty(value = "权属宗地宗地面积")
    private List<QszdZdmjDO> qszdZdmjDOList;
    ...
    public List<QszdZdmjDO> getQszdZdmjDOList() {
        return qszdZdmjDOList;
    }

    public void setQszdZdmjDOList(List<QszdZdmjDO> qszdZdmjDOList) {
        this.qszdZdmjDOList = qszdZdmjDOList;
    }

    public String getQszdDjdcbIndex() {
        return qszdDjdcbIndex;
    }

    public void setQszdDjdcbIndex(String qszdDjdcbIndex) {
        this.qszdDjdcbIndex = qszdDjdcbIndex;
    }
    ...
    public String toString() {
        return "QszdDjdcbResponseDTO{" +
                "qszdDjdcbIndex='" + qszdDjdcbIndex + '\'' +
                ", djh='" + djh + '\'' +
                ", bdcdyh='" + bdcdyh + '\'' +
                ", qsxz='" + qsxz + '\'' +
                ", sztfh='" + sztfh + '\'' +
                ...
                ", qlsdfs='" + qlsdfs + '\'' +
                ", lyqlbh='" + lyqlbh + '\'' +
                ", tdqslyzmcl='" + tdqslyzmcl + '\'' +
                ", zdszb='" + zdszb + '\'' +
                ", zdszd='" + zdszd + '\'' +
                ", zdszn='" + zdszn + '\'' +
                ", zdszx='" + zdszx + '\'' +
                ", gysyqqk='" + gysyqqk + '\'' +
                ", jzwsuqgyqlr='" + jzwsuqgyqlr + '\'' +
                ", ybdjh='" + ybdjh + '\'' +
                ", ydjh='" + ydjh + '\'' +
                ", jlrq=" + jlrq +
                ", gxrq='" + gxrq + '\'' +
