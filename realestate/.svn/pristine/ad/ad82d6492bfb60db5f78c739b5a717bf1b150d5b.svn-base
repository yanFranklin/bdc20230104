...
public class HefeiZwSdkApi extends BaseApp {
    ...
    public ApiResponse apasRegInfo(String apasRegInfo, String attrXml, String formXml) {
        ApiRequest apiRequest = new ApiRequest(HttpConstant.SCHEME_HTTP, Method.POST, "/api/apasRegInfo", SdkConstant.AUTH_TYPE_DEFAULT, "79cb6b93c6c346beb3d47b26d9e99839");
