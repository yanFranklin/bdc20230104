...
public class QlfQlNydsyqDO implements Serializable, AccessData {
    ...
    @ApiModelProperty(value = "承包期限")
    private String cbqx;
    @ApiModelProperty(value = "承包合同编码")
    private String cbhtbm;
    @ApiModelProperty(value = "用途")
    private String yt;
    @ApiModelProperty(value = "用地用海分类")
    private String ydyhfl;
    @ApiModelProperty(value = "土地承包合同")
    ...
    @XmlAttribute(name = "TDCBHT")
    public String getTdcbht() {
        return tdcbht;
    }

    public void setTdcbht(String tdcbht) {
        this.tdcbht = tdcbht;
    }
