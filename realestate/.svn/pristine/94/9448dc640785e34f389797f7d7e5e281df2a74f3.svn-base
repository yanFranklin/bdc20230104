 ...
 * @description
 */
@Table(name = "QLF_QL_YYDJ")
@XmlRootElement(name = "QLF_QL_YYDJ")
@XmlAccessorType(XmlAccessType.NONE)
public class QlfQlYydjOldDO implements Serializable, AccessData {

    private String ysdm = "6002040200";//要素代码
    ...
    @JSONField(format = "yyyy-MM-dd HH:mm:ss")
    @ApiModelProperty(value = "注销异议登记时间")
    ...
    @ApiModelProperty(value = "异议人")
    private String yyr;
    @ApiModelProperty(value = "异议人证件种类")
    private String yyrzjzl;
    @ApiModelProperty(value = "异议人证件种类名称")
    private String yyrzjzlmc;
    @ApiModelProperty(value = "异议人证件号")
    ...
    public void setYyrzjzl(String yyrzjzl) {
        this.yyrzjzl = yyrzjzl;
    }
    ...
    public void setYyrzjzlmc(String yyrzjzlmc) {
        this.yyrzjzlmc = yyrzjzlmc;
    }
    ...
    public void setYyrzjh(String yyrzjh) {
        this.yyrzjh = yyrzjh;
    }
