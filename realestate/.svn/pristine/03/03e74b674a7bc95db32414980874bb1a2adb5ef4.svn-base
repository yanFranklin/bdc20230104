...
layui.use(['form', 'jquery', 'laytpl', 'element', 'laydate', 'table', 'upload'], function () {
                    ...
                    if (data && data.success) {
                        if (data.data) {
                            ...
                            if(!GetQueryString("fwHsIndex")){
                                addParamToFrameUrl("fwHsIndex=" + data.data.fwHsIndex);
                            }
                        }
    ...
    table.on('toolbar(dataTable)', function (obj) {
        ...
        if (obj.event === "addzhs") {
            if($("#fwHsIndex").val()){
                toView(getIP()+'/fwzhs/info?fwHsIndex=' + $("#fwHsIndex").val() + "&hslx=yc",
    ...
    table.on('tool(dataTable)', function (obj) {
        ...
        if (obj.event === "updatezhs") {
            if (data && data.fwZhsIndex) {
                ...
                toView(getIP()+"/fwzhs/info?fwHsIndex=" + $("#fwHsIndex").val() + "&fwZhsIndex=" + zhsIndex+ "&hslx=yc",
