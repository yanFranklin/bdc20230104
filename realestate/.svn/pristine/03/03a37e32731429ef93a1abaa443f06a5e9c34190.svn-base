...
<head>
    ...
    <link rel="stylesheet" href="../css/vis.css?33">
    ...
    <script src="../js/vis.js?v=1.1"></script>
...
<input type="text" class="layui-input layui-hide" name="fwHsIndex" id="fwHsIndex"
       value="${fwHsIndex!}">
<input type="text" class="layui-input layui-hide" name="bdcdyh" id="bdcdyh"
       value="${bdcdyh!}">
<div id="mygraph"></div>
...
<script src="../js/fwhs/fwhsBgHistoryNew.js?v=1.1"></script>
</body>