 ...
 * @description 从原项目加载数据到建设用地使用权
 */
@Service
public class InitYxmToBdcJsydsyqServiceImpl extends InitBdcJsydsyqAbstractService{
    /**
     * @return 对照开关值
     * @author <a href="mailto:yanzhenkun@gtmap.cn">yanzhenkun</a>
     * @description
    ...
    public BdcQl initQlxx(InitServiceQO initServiceQO) throws Exception {
        return initFromYxm(initServiceQO,BdcJsydsyqDO.class);
    }
}
