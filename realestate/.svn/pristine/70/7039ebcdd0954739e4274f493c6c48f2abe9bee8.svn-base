...
layui.use(['jquery', 'form', 'layer'], function () {
    ...
    $(function () {
        ...
        form.on("submit(prev)", function () {
            window.location.href = getContextPath() + "/view/xxbl/xxblUpdateinfo.html?processInsId=" + processInsId + "&type=" + type;
        });
        ...
        function judgeZslx(zslx){
            ...
            switch (zslx) {
                case 'zs':
                    url = getContextPath() + "/view/xxbl/xxblCheckZs.html?xmid=" + xmid + "&qllx=" + qllx + "&bdcdyfwlx=" + bdcdyfwlx + "&processInsId=" + processInsId + "&type=" + type;
                    break;
                case 'zm':
                    url = getContextPath() + "/view/xxbl/xxblCheckZm.html?xmid=" + xmid + "&qllx=" + qllx + "&bdcdyfwlx=" + bdcdyfwlx + "&processInsId=" + processInsId + "&type=" + type;
                    break;
                case 'list':
                    url = getContextPath() + "/view/xxbl/xxblZsList.html?xmid=" + xmid + "&qllx=" + qllx + "&bdcdyfwlx=" + bdcdyfwlx + "&processInsId=" + processInsId + "&type=" + type;
                    break;
                case 'no':
                    url = '';
                    break;
