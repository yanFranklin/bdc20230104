...
import cn.gtmap.realestate.etl.core.domian.huaian.*;
        ...
        if (StringUtils.isNotBlank(infApply.getInternalNo()) && StringUtils.isNotBlank(infApply.getDeptYwRegNo())) {
            ...
            if (StringUtils.isNotBlank(bnInfSpare.getGzlslid())) {
                ...
                if (Objects.nonNull(getxtpz)) {
                    ...
                    if (StringUtils.isNotBlank(getxtpz.getQlkind())) {
                        bnInfApply.setQlKind(getxtpz.getQlkind());
                    }
                    if (StringUtils.isNotBlank(getxtpz.getPromisetype())) {
                        bnInfApply.setPromiseType(getxtpz.getPromisetype());
                    }
                    if (Objects.nonNull(getxtpz.getPromise())) {
                        bnInfApply.setPromise(getxtpz.getPromise());
                    }

                    if (Objects.nonNull(getxtpz.getFdbjsx())) {
                        bnInfApply.setAnticipate(getxtpz.getFdbjsx());
                    }

                    if (Objects.nonNull(getxtpz.getFdbjsxlx())) {
