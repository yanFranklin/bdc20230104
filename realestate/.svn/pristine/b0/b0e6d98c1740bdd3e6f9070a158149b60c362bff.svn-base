...
function initCfTable() {
    layui.use(['jquery', 'layer', 'element', 'form', 'table', 'laytpl'], function () {
        ...
        var unitTableTitle = [{type: 'checkbox', fixed: 'left'},
            {field: 'bdcdyh', title: '不动产单元号', minWidth: 262,templet: '#cfbdcdyhTpl'
            },
            {field: 'cfwh', title: '查封文号', minWidth: 200},
            {field: 'cflx', title: '查封类型', minWidth: 80, templet: '#cflx'},
            {field: 'cfjg', title: '查封机关', minWidth: 120},
            {field: 'ywrmc', title: '被查封人', minWidth: 90},
            {
                field: 'pplzzt', title: '匹配落宗状态', minWidth: 146, align: "center", templet: function (obj) {
            ...
            {field: 'zt', title: '限制状态', minWidth: 86, templet: '#cqzzt', align: "center"},
            ...
            {field: 'zl', title: '坐落', minWidth: 180,sort: true},
            {field: 'cfqssj', title: '查封开始时间', minWidth: 140,sort: true,
                templet: function (d) {
                    if (d.cfqssj) {
            ...
            {field: 'cfjssj', title: '查封结束时间', minWidth: 140,sort: true,
                templet: function (d) {
                    if (d.cfjssj) {
