 ...
 * @descriptionv 某属性的值等于第二个值 就读取第三方字典值否则不读取
 */
public class EqualsDsfZdDmElseNotCustomConvert implements GtmapCompareableCustomConverter {
    private String param;
    private Object destObject;
    private Object srcObject;

    private static final Logger LOGGER = LoggerFactory.getLogger(EqualsDsfZdDmElseNotCustomConvert.class);
