...
public class DbxxQO {
     ...
     * 当前流程需要注销项目的权属状态
     */
    private Integer zxQszt;

    /**
     * 权利表名称
     */
    private String qlTable;
    ...
    public String getQlTable() {
        return qlTable;
    }

    public void setQlTable(String qlTable) {
    ...
    public Integer getZxQszt() {
        return zxQszt;
    }

    public void setZxQszt(Integer zxQszt) {
        this.zxQszt = zxQszt;
    }
    ...
    public List<Integer> getYgdjzl() {
        return ygdjzl;
    }

    public void setYgdjzl(List<Integer> ygdjzl) {
        this.ygdjzl = ygdjzl;
    }
