...
public class BdcSlSfxmDO implements Serializable {
    ...
    @ApiModelProperty(value = "缴费书二维码url--常州按收费项目推送二维码使用")
    private String jfsewmurl;

    @ApiModelProperty(value = "缴费书二维码--常州按收费项目推送二维码使用")
    private String jfsbm;

    @ApiModelProperty(value = "缴款码时间--常州按收费项目推送二维码使用")
    private Date jkmsj;

    @ApiModelProperty(value = "缴款码时间--常州按收费项目推送二维码使用")
    private String tkdh;

    @ApiModelProperty(value = "发票号--常州按收费项目推送二维码使用")
    private String fph;
    @ApiModelProperty(value = "获取发票号时间--常州按收费项目推送二维码使用")
    ...
    public void setDdjb(String ddjb) {
        this.ddjb = ddjb;
    }
