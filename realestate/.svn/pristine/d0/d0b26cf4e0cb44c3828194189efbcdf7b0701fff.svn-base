...
layui.use(['jquery', 'element', 'form', 'table', 'laydate'], function () {
    ...
    $(function () {
                ...
                success: function (data) {
                    ...
                    if (data && data.length > 0) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            searchData.cxywcs.push({"tyshxydm": data[i].zjh});
                        }
        ...
        function search() {
            ...
            if(searchData.cxywcs.length >0){
                for (var i = 0; i < searchData.cxywcs.length; i++) {
                    ...
                    // 重新请求
                    $.ajax({
                        url: "/realestate-inquiry-ui/rest/v1.0/gx/shijgxCx/zhfrkqsshzzdjxx",
                        type: "POST",
        ...
        $(".upload-pdf").click(function () {
            uploadPdf(gzlslid,"shijzhfrkqsshzzdjxx","综合法人库-全市社会组织登记信息",key,"市级共享交换平台");
        });
