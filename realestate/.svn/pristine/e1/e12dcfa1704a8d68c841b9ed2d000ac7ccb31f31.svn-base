...
public class CommonConstantUtils {
    ...
    */
    ...
    //所有的收费单打印类型
    public static final String[] SFD_ALL_DYLX = {"sfd", "dysfd", "sfdpl", "dysfdpl", "ycslsfd", "jnpz", "jnpzpl", "dyjnpz", "dyjnpzpl", "hmsflxd", "hmsflxdpl"};
    ...
    * */
    ...
    //base64 前缀-pdf
    public static final String BASE64_QZ_PDF = "data:image/pdf;base64,";
