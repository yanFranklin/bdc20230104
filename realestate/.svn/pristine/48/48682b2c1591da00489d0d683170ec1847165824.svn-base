...
import cn.gtmap.realestate.init.service.qlr.impl.InitYywrToBdcQlrServiceImpl;
 ...
 * @description 获取原项目义务人做不动产权利人服务单元测试
 */
...
public class InitYywrToBdcQlrServiceImplTest {
    @Autowired
    private InitYywrToBdcQlrServiceImpl initYywrToBdcQlrService;
    @Autowired
    ...
    public void initQlr(){
        ...
        List<BdcQlrDO> bdcQlrDOList = initYywrToBdcQlrService.initQlr(initServiceQO);
        Assert.assertEquals("原项目义务人1",bdcQlrDOList.get(0).getQlrmc());
        Assert.assertEquals("1",bdcQlrDOList.get(0).getQlrlb());
        Assert.assertEquals("原项目义务人2",bdcQlrDOList.get(1).getQlrmc());
        Assert.assertEquals("1",bdcQlrDOList.get(1).getQlrlb());
        //组合业务权利人测试
        ...
        bdcQlrDOList = initYywrToBdcQlrService.initQlr(initServiceQO);
        Assert.assertEquals("组合原项目义务人1",bdcQlrDOList.get(0).getQlrmc());
        Assert.assertEquals("1",bdcQlrDOList.get(0).getQlrlb());
        Assert.assertEquals("组合原项目义务人2",bdcQlrDOList.get(1).getQlrmc());
        Assert.assertEquals("1",bdcQlrDOList.get(1).getQlrlb());
    }
