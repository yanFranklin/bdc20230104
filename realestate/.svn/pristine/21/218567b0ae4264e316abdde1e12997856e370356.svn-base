 ...
 */
public class NationalAccessXmlTdsyqScdjImpl extends NationalAccessXmlAbstractService {
    private Set<NationalAccessDataService> nationalAccessDataTdsyqScdjServiceSet;

    private Set<NationalAccessQjsjService> nationalAccessDataQjsjSet;

    public void setNationalAccessDataTdsyqScdjServiceSet(Set<NationalAccessDataService> nationalAccessDataTdsyqScdjServiceSet) {
        this.nationalAccessDataTdsyqScdjServiceSet = nationalAccessDataTdsyqScdjServiceSet;
    }
    ...
    public Set<NationalAccessDataService> getNationalAccessDataServiceSet() {
        return this.nationalAccessDataTdsyqScdjServiceSet;
    }
