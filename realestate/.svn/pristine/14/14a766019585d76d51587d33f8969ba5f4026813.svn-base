...
public class InitBdcZsxxServiceImplTest {
    @Autowired
    private InitBdcZsxxServiceImpl initBdcZsxxService;
    @Test
    public void getVal() throws Exception {
        Assert.assertEquals(CommonConstantUtils.ZSLX_ZS.toString(), initBdcZsxxService.getVal());
    }
    ...
    public void initZsxx() throws Exception {
        ...
        List<BdcZsDO> bdcZsList = initBdcZsxxService.initZsxx(initServiceQO);
