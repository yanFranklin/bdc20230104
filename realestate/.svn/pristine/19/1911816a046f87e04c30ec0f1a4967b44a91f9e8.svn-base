 ...
 * @description 受理建设用地，宅基地信息
 */

@JsonTypeInfo(use = JsonTypeInfo.Id.CLASS, include = JsonTypeInfo.As.PROPERTY, property = "@Clazz", defaultImpl = BdcSlJsydDTO.class)
@ApiModel(value = "BdcSlJsydDTO", description = "不动产受理建设用地信息")
public class BdcSlJsydDTO implements BdcSlQl{
