 ...
 * @version 1.0
 * @description 不动产代码转为第三方字典项，如果已经有值，就不处理
 */
public class BdcDmToDsfZdNotEmptyCustomConvert implements GtmapCompareableCustomConverter {

    private String parameter;

    private static final Logger LOGGER = LoggerFactory.getLogger(BdcDmToDsfZdNotEmptyCustomConvert.class);
    ...
    public Object convert(Object existingDestinationFieldValue, Object sourceFieldValue, Class<?> destinationClass, Class<?> sourceClass) {
        if (existingDestinationFieldValue == null || StringUtils.isBlank(existingDestinationFieldValue.toString())) {
            try {
