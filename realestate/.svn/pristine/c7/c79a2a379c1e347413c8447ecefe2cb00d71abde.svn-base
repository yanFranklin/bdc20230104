 ...
 * @description 国有土地使用证类型土地数据转换服务
 */
@Service
public class TdConvertGytdsyzServiceImpl implements TdConvertAbstractService {
    ...
    public void afterPropertiesSet() throws Exception {
        TdConvertStrategyFactory.register(3, this);
    }
    ...
    public void convertTdDataAndImoprtBdcDj(TdsqQO tdsqQO) {
        ...
        try{
            // 1、生成项目信息
            List<BdcXmDO> bdcXmDOList = this.tdMapper.queryGytdsyzXmxx(tdsqQO);
            ...
            // 2、生成建设用地使用权信息
            List<BdcJsydsyqDO> bdcJsydsyqDOList = this.tdMapper.queryGytdsyzJsydsyqxx(tdsqQO);
            ...
            // 3、生成查封信息
            List<BdcCfDO> bdcCfDOList = this.tdMapper.queryGytdsyzCfxx(tdsqQO);
            ...
            // 4、生成抵押权信息
            List<BdcDyaqDO> bdcDyaqDOList = this.tdMapper.queryGytdsyzDyaqxx(tdsqQO);
            ...
            // 5、生成权利人
            List<BdcQlrDO> bdcQlrDOList = this.tdMapper.queryGytdsyzQlrxx(tdsqQO);
            if(CollectionUtils.isNotEmpty(bdcQlrDOList)){
                this.bdcEntityMapper.batchSaveSelective(bdcQlrDOList);
            }

            //6、生成证书信息
            List<BdcZsDO> bdcZsDOList = this.tdMapper.queryGytdsyzZsxx(tdsqQO);
            ...
            if(tdsqQO.getTdzt() != null && tdsqQO.getTdzt() == 5){
                ...
                // 7、生成项目证书信息
                List<BdcXmZsGxDO> bdcXmZsGxDOList = tdMapper.queryGytdsyzXmZsGxxx(tdsqQO);
