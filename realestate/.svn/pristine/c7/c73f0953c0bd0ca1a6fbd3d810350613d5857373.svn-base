 ...
 * @description
 */
@Table(name = "QLF_FW_FDCQ_QFSYQ")
@XmlRootElement(name = "QLF_FW_FDCQ_QFSYQ")
@XmlAccessorType(XmlAccessType.NONE)
public class QlfFwFdcqQfsyqOldDO implements Serializable, AccessData {

    private String ysdm = "6002010210";//要素代码
    ...
    private String qllx;
    @ApiModelProperty(value = "建（构）筑物编号非空")
    private String jgzwbh;
    @ApiModelProperty(value = "建（构）筑物名称非空")
    private String jgzwmc;
    @ApiModelProperty(value = "建（构）筑物数量＞0")
    private String jgzwsl;
    @ApiModelProperty(value = "建（构）筑物面积＞0单位：平方米")
    private String jgzwmj;
