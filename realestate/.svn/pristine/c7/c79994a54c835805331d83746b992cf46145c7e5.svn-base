...
public class VersionV1 {
    ...
    public static void main(String[] args){
        try {
            ...
            changeVersion(properties, "../", GTC_PARENT_V2, GTC_PARENT_V1, "version");
            changeVersion(properties, "../common/", COMMON_GC_V2, COMMON_GC_V1, "artifactId");
            changeVersion(properties, "../common/", GTC_PARENT_V2, GTC_PARENT_V1, "version");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
