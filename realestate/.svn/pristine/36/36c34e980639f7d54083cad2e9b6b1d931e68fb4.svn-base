...
layui.use(['table', 'laytpl', 'laydate', 'layer', 'form'], function () {
    ...
    table.render({
        ...
        cols: [[
            ...
            {
                width: 180, sort: false, field: 'jfyywh', title: '解封（押）业务号',
                templet: function (d) {
                    // 抵押
                    if(d.qllx && d.zxdyywh && d.qllx == '37'){
                        return d.zxdyywh;
                    }
                    // 查封
                    if (d.qllx && d.jfywh && d.qllx== '98'){
                        return d.jfywh;
                    }
                    return '';
                }
            ...
            {
                width: 150, sort: false, field: 'jfysj', title: '解封（押）时间',
                templet: function (d) {
                    // 抵押
                    if(d.qllx && d.qllx == '37'){
                        return format(d.zxdydjsj);
                    }
                    // 查封
                    if (d.qllx && d.qllx== '98'){
                        return format(d.jfdjsj);
                    }
                    return '';
                }
            },
