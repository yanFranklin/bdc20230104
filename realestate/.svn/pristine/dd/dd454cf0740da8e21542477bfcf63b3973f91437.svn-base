 ...
 * @description
 */
public interface ZrzyXtJgpzRestService {
     ...
     */
    @PostMapping(value = "/realestate-natural/rest/v1.0/jgpz")
     ...
     * @author <a href="mailto:hanyi@gtmap.cn">hanyi</a>
     */
    @GetMapping(value = "/realestate-natural/rest/v1.0/jgpz/query")
     ...
     * @author <a href="mailto:hanyi@gtmap.cn">hanyi</a>
     */
    @DeleteMapping(value = "/realestate-natural/rest/v1.0/jgpz/delete")
     ...
     * @date : 2020/9/9 10:37
     */
    @PostMapping(value = "/realestate-natural/rest/v1.0/jgpz/pl")
