...
public interface BdcXtJgRestService {
     ...
     */
    @PostMapping(path = "/init/rest/v1.0/xtjg/list")
     ...
     * @author <a href ="mailto:hanyi@gtmap.cn">hanyi</a>
     */
    @GetMapping(path = "/init/rest/v1.0/xtjg/list/ayjs/yhmc/like")
     ...
     */
    @GetMapping(path = "/init/rest/v1.0/xtjg/xtjglzr")
     ...
     * @author <a href="mailto:chenyucheng@gtmap.cn">chenyucheng</a>
     */
    @GetMapping(path = "/init/rest/v1.0/xtjg/xtjglzrByPage")
     ...
     */
    @GetMapping(path = "/init/rest/v1.0/xtjg/xtjgByPage")
    Page<BdcXtJgDTO> queryJgByPage(@RequestBody Pageable pageable,
                                   @RequestParam(name = "bdcXtjgQOJSON", required = false) String bdcXtjgQOJSON);
     ...
     */
    @DeleteMapping(path = "/init/rest/v1.0/xtjg/{gxid}")
     ...
     * @description 新增机构领证人
     */
    @PostMapping(path = "/init/rest/v1.0/xtjg/jglzr")
     ...
     * @author <a href="mailto:yaoyi@gtmap.cn">yaoyi</a>
     */
    @PostMapping(path = "/init/rest/v1.0/xtjg/sfky/{sfky}")
     ...
     * @description 新增机构
     */
    @PutMapping(path = "/init/rest/v1.0/xtjg")
     ...
     * @description
     */
    @PutMapping(path = "/init/rest/v1.0/queryBatchBdcXtJg")
     ...
     * @return 月结银行名称
     */
    @PostMapping(path = "/init/rest/v1.0/list/yjyhmc")
    List<String> listYjyhmc();
}
