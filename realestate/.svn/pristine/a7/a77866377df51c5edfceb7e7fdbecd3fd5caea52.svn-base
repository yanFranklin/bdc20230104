...
import cn.gtmap.realestate.common.core.service.rest.refleshconfig.EcertificateAppRefleshConfigRestService;
 ...
 * @Description:
 */
public class RefleshConfigRestController implements EcertificateAppRefleshConfigRestService {
    @Autowired
