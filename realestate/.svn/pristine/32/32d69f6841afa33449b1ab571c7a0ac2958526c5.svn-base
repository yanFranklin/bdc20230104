 ...
 */
@XmlRootElement(name = "KTF_QT_XZDZW")
@XmlAccessorType(XmlAccessType.NONE)
public class KtfQtXzdzwOldDO implements Serializable {

    private String ysdm = "6001990200";//要素代码
    private String bdcdyh;//不动产单元号
    private Integer bsm;//标识码
    private String zdzhdm;//宗地宗海代码
    private String xzdzwlx;//线状定着物类型
