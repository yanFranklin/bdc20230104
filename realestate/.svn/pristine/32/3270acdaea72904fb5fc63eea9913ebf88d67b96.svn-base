...
layui.use(['table', 'laytpl', 'laydate', 'layer', 'form'], function () {
    ...
    table.render({
        ...
        cols: [[
            ...
            {minWidth: 200, sort: true, field: 'lqbm', title: '提取部门'},
            {minWidth: 200, sort: false, field: 'lqbmid', title: '提取部门id'},
            {minWidth: 150, sort: true, field: 'lqr', title: '领取人'},
            {minWidth: 150, sort: true, field: 'lqrid', title: '领取人id'},
            // {minWidth:200,   field:'sybmmc',title:'使用部门'},
            // {minWidth:150,   field:'syr',   title:'使用人'},
            {minWidth: 150, sort: false, field: 'cjr', title: '创建人'},
            {minWidth: 150, sort: false, field: 'cjrid', title: '创建人id'},
            {
            ...
            {
                minWidth: 200,sort: false,field: 'tqsj',title: '提取时间',
                templet: function (d) {
                    return format(d.tqsj);
                }
             },
            {
                minWidth: 200,sort: false,field: 'lqsj',title: '领取时间',
                templet: function (d) {
                    return format(d.lqsj);
                 }
             },
            {
