 ...
 * @description 新建商品房预售状态
 */
public class XjspfysStatus extends StatusDecorator {
     ...
     * @description 构造函数
     */
    public XjspfysStatus(StatusResource resource) {
        super(resource);
    }
    ...
    public Integer getStatusCount() {
        if (this.sSjBdcdyhxsztDO != null) {
            return this.sSjBdcdyhxsztDO.getXjspfys();
        }
        return 0;
    }
