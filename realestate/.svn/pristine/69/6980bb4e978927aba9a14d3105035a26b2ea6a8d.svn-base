...
public class QlfQlDyaqDO implements Serializable, AccessData {
    ...
    private String ysdm = "6002030100";//要素代码
    ...
    private String dyqr;
    @ApiModelProperty(value = "抵押权人证件种类")
    private String dyqrzjzl;
    @ApiModelProperty(value = "抵押权人证件种类名称")
    ...
    @ApiModelProperty(value = "不动产登记证明号简称")
    ...
    @ApiModelProperty(value = "抵押权顺位")
    private String dyqsw;
    @ApiModelProperty(value = "是否预告登记")
    ...
    private String dbfw;
    @ApiModelProperty(value = "债务履行期限（债务确定期间）")
    private String dyqx;
    @ApiModelProperty(value = "是否存在禁止或者限制转让抵押不动产的约定")
    ...
    public void setZxdysj(Date zxdysj) {
        this.zxdysj = zxdysj;
    }
    ...
    public void setDybdclxmc(String dybdclxmc) {
        this.dybdclxmc = dybdclxmc;
    }
    ...
    public void setDyqrzjzl(String dyqrzjzl) {
        this.dyqrzjzl = dyqrzjzl;
    }
    ...
    public void setDyqrzjzlmc(String dyqrzjzlmc) {
        this.dyqrzjzlmc = dyqrzjzlmc;
    }
