...
public class GxWwSqxxDo {
    ...
    /**
     * 税务状态 (0：无需纳税，1：未核税，2：已核税，3：已缴税）放代码
     */
    private String swzt;
    /**
     * 查封开始期限
    ...
    public void setCfzxr(String cfzxr) {
        this.cfzxr = cfzxr;
    }
    ...
    public void setCfzxrzjzl(String cfzxrzjzl) {
        this.cfzxrzjzl = cfzxrzjzl;
    }
    ...
    public void setCfzxrzjh(String cfzxrzjh) {
        this.cfzxrzjh = cfzxrzjh;
    }
    ...
    public void setCfzxrdh(String cfzxrdh) {
        this.cfzxrdh = cfzxrdh;
    }
    ...
    public void setYcfid(String ycfid) {
        this.ycfid = ycfid;
    }
    ...
    public void setYcfwh(String ycfwh) {
        this.ycfwh = ycfwh;
    }
    ...
    public void setSfxzzr(String sfxzzr) {
        this.sfxzzr = sfxzzr;
    }
    ...
    public void setSfczdyyd(String sfczdyyd) {
        this.sfczdyyd = sfczdyyd;
    }
    ...
    public void setSfytdm(String sfytdm) {
        this.sfytdm = sfytdm;
    }
}
