 ...
 */
@Table(name = "zd_djdcb")
public class ZdDjdcbDO extends DjxxDO {
    /**
     * 主键
     */
    @Id
    ...
    @ApiModelProperty(value = "是否新项目")
    private String sfxxm;
    ...
    public String getSfxxm() {
        return sfxxm;
    }

    public void setSfxxm(String sfxxm) {
        this.sfxxm = sfxxm;
    }
