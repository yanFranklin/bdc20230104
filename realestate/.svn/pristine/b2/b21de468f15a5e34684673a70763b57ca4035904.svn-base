...
import cn.gtmap.realestate.common.core.service.rest.realestate_e_certificate.BdcDzzzFeignRestService;
 ...
 * @description 电子证照feign接口
 */
@FeignClient("e-certificate-app")
public interface BdcDzzzFeignService extends BdcDzzzFeignRestService {
}
