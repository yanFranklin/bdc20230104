 ...
 */
public interface ZrzyXtLscsRestService {
    /**
     * 批量添加临时参数数据
     ...
     * @author <a href="mailto:zhuyong@gtmap.cn>zhuyong</a>"
     */
    @PostMapping(value = "/realestate-natural/rest/v1.0/lscs")
    int addValues(@RequestBody List<ZrzyXtLscsDO> lscsDOList);
     ...
     * @author <a href="mailto:zhuyong@gtmap.cn>zhuyong</a>"
     */
    @DeleteMapping(value = "/realestate-natural/rest/v1.0/lscs")
    int deleteRecords(@RequestBody List<ZrzyXtLscsDO> lscsDOList);
}
