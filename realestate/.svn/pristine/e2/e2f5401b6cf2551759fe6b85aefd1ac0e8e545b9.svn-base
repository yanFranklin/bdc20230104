...
import cn.gtmap.realestate.init.service.qlr.impl.InitYqlrToBdcQlrServiceImpl;
 ...
 * @description 获取原项目权利人做不动产权利人服务单元测试
 */
...
public class InitYqlrToBdcQlrServiceImplTset {
    @Autowired
    private InitYqlrToBdcQlrServiceImpl initYqlrToBdcQlrService;
    @Autowired
    ...
    public void initQlr(){
        ...
        List<BdcQlrDO> bdcQlrDOList = initYqlrToBdcQlrService.initQlr(initServiceQO);
        ...
        bdcQlrDOList = initYqlrToBdcQlrService.initQlr(initServiceQO);
