...
public interface DtcxConfigService {
     ...
     * @return
     */
    void saveAllDtcxCxxx(ZrzyDtcxDTO bdcDtcxDTO, boolean fuzhiCx);
     ...
     * @return
     */
    Page<ZrzyDtcxDTO> listDtcxPage(ZrzyDtcxQO qo, Pageable pageable);
     ...
     * @author hanyaning
     */
    ZrzyDtcxDTO getConfigsByCxdh(String cxdh);
}
