    ...
    $(function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: 'fzr', title: '发证人', width: 150, align: 'center'},
                {
                    field: 'fzsj', title: '发证时间', width: 150, align: 'center',
                    templet: function (d) {
                ...
                {field: 'zzbs', title: '电子证照标识', width: 150, align: 'center', hide: true},
                {field: 'storageid', title: '电子证照附件id', width: 150, align: 'center', hide: true},
                {field: 'zsid', title: '证书id', width: 150, align: 'center', hide: true},
                {field: 'zzzt',title: '证照状态',width: 150,align: 'center',
                    templet: function (d) {
                        return formatZzzt(d.zzzt)
                    }
                },
        ...
        function cancelDzzz(d, col) {
            ...
            iszf(zsids).done(function () {
                ...
                $.ajax({
                    url: "/realestate-inquiry-ui/rest/v1.0/dzzzcz/cancelDzzz",
                    type: "POST",
                    dataType: 'json',
                    contentType: "application/json;charset=UTF-8",
                    data: JSON.stringify(xmids),
