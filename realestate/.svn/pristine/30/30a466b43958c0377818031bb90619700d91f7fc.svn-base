...
import cn.gtmap.realestate.common.core.service.rest.refleshconfig.EngineAppRefleshConfigRestService;
 ...
 * @version: 2022/11/15/14:38
 * @Description:
 */
public class RefleshConfigRestController implements EngineAppRefleshConfigRestService {
    @Autowired
    ...
    @Override
    public String refleshConfigValue(String bdcTsywPzDOStr) throws UnsupportedEncodingException {
