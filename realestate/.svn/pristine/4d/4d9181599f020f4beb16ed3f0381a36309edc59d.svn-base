package cn.gtmap.realestate.certificate.util.encrypt;
...
public class SM2 {
    ...
    public byte[] encrypt(String input, ECPoint publicKey) {
        ...
        byte[] inputBuffer = StringToolUtils.strToByteUtf8(input);
        if (debug) {
    ...
    public String decrypt(byte[] encryptData, BigInteger privateKey) {
        ...
        if (Arrays.equals(u, C3)) {
            ...
            return StringToolUtils.byteToStrUtf8(M);
			/*try {
    ...
    public static class TransportEntity implements Serializable {
        public final byte[] R; //R点
        public final byte[] S; //验证S
        public final byte[] Z; //用户标识
        public final byte[] K; //公钥
    ...
    public static class KeyExchange {
         ...
         * @param entity 传输实体
         */
        public boolean keyExchange_4(TransportEntity entity) {
