...
public class Constants {
     ...
     *  申请书打印类型
     **/
    public static final String[] SL_SQS_DYLX = {"sqs","grsqs","dwsqs","dyasqs","grsqspl","dwsqspl","dyasqspl","grsqs-zh","grsqs-cq","dwsqs-cq","grsqs-zh","grsqs-cqzx","dwsqs-cqzx","dwsqs-spfscdj","ycsqd",
            "grsqs-zhpl","grsqs-cqpl","dwsqs-cqpl","grsqs-zhpl","grsqs-cqzxpl","dwsqs-cqzxpl","dwsqs-spfscdjpl","ycsqdpl","zhsqs"};
    ...
    * */
    ...
    public static final String[] SL_ALL_DYLX = {"sfd", "dysfd", "sfdpl", "dysfdpl", "sjd", "sjdpl", "czsjd", "czsjdpl",
            "ycslsfd", "djgzs", "djgzspl","qjdcsjd","cqsjd","dyasjd","noczsjd","qtsjd","ycsl","ythqrd","ythclfqrd","hmsflxd","hmsflxdpl",
            "ycgrsqs", "ycdwsqs", "ycdyasqs", "yczhsqs" , "ycsjd", "ycsjdpl", "ycczsjd", "ycczsjdpl","ycnoczsjd","yccqsjd"};
    ...
    /**常州声请书 */
    public static final String[] SL_SQS_DYLX_CZ = {"sqs"};
     ...
     *  所有的收件单打印类型
     **/
    public static final String[] SL_SJD_DYLX = {"sjd","sjdpl", "czsjd","czsjdpl",CommonConstantUtils.DYLX_ZHSJD,
            "qjdcsjd", "cqsjd", "dyasjd", "noczsjd", "qtsjd", "ycsjd","ycsjdpl", "ycczsjd", "ycczsjdpl","ycnoczsjd","yccqsjd",
            "cqsjdpl", "dyasjdpl"};
     ...
     * 业务类型-不予受理告知书编号
     */
    public static final String BYSL_GZSBH = "GZSBH";
}
