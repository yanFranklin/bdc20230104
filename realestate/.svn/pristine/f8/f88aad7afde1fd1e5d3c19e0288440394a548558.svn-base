        ...
        for (Map<String, Object> dataMap : exportData) {
            ...
            while (iter.hasNext()) {
                ...
                if(StringUtils.equals(value.toString(), "xh")){
                    ...
                    sheet.addCell(new Label(colnum, rownum, getMcByDm(zdListMap, value, String.valueOf(cellValue)), wcfLeft));
                } else if (StringUtils.equals("zdzhyt", value.toString())) {
                    sheet.addCell(new Label(colnum, rownum, getMcByDm(zdListMap, "tdyt", String.valueOf(cellValue)), wcfLeft));
                } else if (StringUtils.equals("ghyt", value.toString())) {
                    sheet.addCell(new Label(colnum, rownum, getMcByDm(zdListMap, "fwyt", String.valueOf(cellValue)), wcfLeft));
