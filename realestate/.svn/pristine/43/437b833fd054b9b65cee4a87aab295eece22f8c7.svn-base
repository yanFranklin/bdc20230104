 ...
 * @description 初始化外联项目权利人到义务人
 */
@Service
public class InitWlxmQlrToBdcYwrServiceImpl extends InitBdcYwrAbstractService {
            ...
            if(CollectionUtils.isNotEmpty(listLsgx)){
                for(BdcXmLsgxDO bdcXmLsgxDO:listLsgx){
                    ...
                    if(StringUtils.isNotBlank(bdcXmLsgxDO.getYxmid()) && CommonConstantUtils.SF_S_DM.equals(bdcXmLsgxDO.getWlxm())){
                        ...
                        bdcQlrDOList = bdcQlrService.inheritYxmBdcQlr(bdcXmLsgxDO.getYxmid(),initServiceQO.getXmid(), CommonConstantUtils.QLRLB_YWR);
                        break;
                    }
                }
            }
