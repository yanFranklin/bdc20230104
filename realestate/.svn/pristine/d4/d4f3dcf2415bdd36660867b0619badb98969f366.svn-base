...
layui.use(['jquery', 'element', 'form', 'table', 'laydate'], function () {
    ...
    $(function () {
        ...
        getStateById(false, formStateId, 'lcsjMbfqydjzs');
        ...
        function search() {
            ...
            if(searchData.cxywcs.length >0){
                ...
                for (var paramlength = 0; paramlength < searchData.cxywcs.length; paramlength++) {
                    ...
                    // 重新请求
                    $.ajax({
                        url:"/realestate-inquiry-ui/rest/v1.0/gx/naturalResources/mbfqydjzs",
                        type: "POST",
        ...
        $(".upload-pdf").click(function () {
            uploadPdf(gzlslid,"sjmbfqydjzs","民政部-民办非企业单位登记证书查询",key,"省级数据共享交换平台");
        });
    });
