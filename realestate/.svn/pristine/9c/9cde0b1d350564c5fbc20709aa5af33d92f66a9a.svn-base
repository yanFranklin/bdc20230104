package cn.gtmap.realestate.common.core.dto.exchange.nantong.yrb.clfskxxhq.response;
 ...
 * @description 返回实体
 */
public class YrbClfskxxFhmResponse {
    ...
    public void setHdjsjg(String hdjsjg) {
        this.hdjsjg = hdjsjg;
    }
}
