...
public class BdcDpCxController extends BaseController {
    ...
    @GetMapping("/getBdcDpConfig")
    public Object getBdcDpConfig(){
        return bdcDpCxFeignService.getBdcDpConfig();
    }
    /**
     * @param bdcDpTjQO
     * @return
    ...
    public Object getDyjetjTb(@RequestBody BdcDpTjQO bdcDpTjQO){
        ...
        if(StringUtils.isNotBlank(bdcDpTjQO.getProcessDefKey())){
            bdcDpTjQO.setProcessDefKeyList(Arrays.asList(StringUtils.split(bdcDpTjQO.getProcessDefKey())));
        }
