...
import cn.gtmap.realestate.exchange.core.support.mybatis.page.PaginationInterceptor;
...
public class Repository extends SqlSessionDaoSupport implements Repo {
    ...
    public Map orderBySort(Pageable pageable, Map map) {
        if (pageable != null && pageable.getSort() != null && !"UNSORTED".equals(String.valueOf(pageable.getSort()))) {
