...
import cn.gtmap.realestate.common.core.service.rest.refleshconfig.RegisterAppRefleshConfigRestService;
 ...
 * @Description:
 */
public class RefleshConfigRestController implements RegisterAppRefleshConfigRestService {
    @Autowired
