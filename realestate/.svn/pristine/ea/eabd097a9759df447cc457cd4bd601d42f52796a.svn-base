 ...
 */
@Service
public class BdcdysdztSyncMqService extends MQConsumer {

    /**
     * 日志组件
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(BdcdysdztSyncMqService.class);
     ...
     */
    @RabbitListener(containerFactory = "rabbitListenerContainerFactory",queues = "update-bdcdysdzt-queue")
    @RabbitHandler
    public void receiveBdcdysdZt(String msg, Channel channel, Message message) throws IOException {
        Map<String,Object> logData = new HashMap<>();
        logData.put("msg",msg);
        String logName = RabbitMqEnum.QueueName.BDCDYSDZTQUEUE.getCode();
