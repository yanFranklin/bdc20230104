...
layui.use(['jquery', 'element', 'form', 'table', 'laydate'], function () {
    ...
    $(function () {
        ...
        function search() {
            ...
            if(searchData.cxywcs.length >0){
                for (var i = 0; i < searchData.cxywcs.length; i++) {
                    ...
                    // 重新请求
                    $.ajax({
                        url: "/realestate-inquiry-ui/rest/v1.0/gx/shijgxCx/zhfrkkjxjrqyrdxx",
                        type: "POST",
        ...
        $(".upload-pdf").click(function () {
            uploadPdf(gzlslid,"shijzhfrkkjxjrqyrdxx","综合法人库-科技小巨人企业认定信息",key,"市级共享交换平台");
        });
