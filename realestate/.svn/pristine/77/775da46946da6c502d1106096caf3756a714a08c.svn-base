...
import cn.gtmap.realestate.common.core.service.rest.refleshconfig.BuildingAppRefleshConfigRestService;
 ...
 * @version: 2022/11/15/14:26
 * @Description:
 */
public class RefleshConfigRestController implements BuildingAppRefleshConfigRestService {
    @Autowired
