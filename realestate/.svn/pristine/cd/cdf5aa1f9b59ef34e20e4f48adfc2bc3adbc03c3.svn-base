...
import cn.gtmap.realestate.common.core.service.rest.refleshconfig.CheckAppRefleshConfigRestService;
 ...
 * @version: 2022/11/15/14:34
 * @Description:
 */
public class RefleshConfigRestController implements CheckAppRefleshConfigRestService {
    @Autowired
