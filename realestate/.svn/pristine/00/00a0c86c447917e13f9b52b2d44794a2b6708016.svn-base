package cn.gtmap.realestate.common.core.dto.exchange.changzhou.zjjg;

import cn.gtmap.realestate.common.core.domain.accept.BdcSlZjjgxyjcDO;
...
public class BdcSlZjjgxyDTO {
    ...
    @ApiModelProperty(value = "资金监管监管协议对象缴存明细")
    List<BdcSlZjjgxyjcDO> jymx;
    ...
    public List<BdcSlZjjgxyjcDO> getJymx() {
        return jymx;
    }

    public void setJymx(List<BdcSlZjjgxyjcDO> jymx) {
        this.jymx = jymx;
    }
}
