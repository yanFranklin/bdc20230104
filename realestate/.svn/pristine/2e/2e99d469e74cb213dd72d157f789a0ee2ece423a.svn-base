 ...
 * @Version 1.0
 * @description 1.0，2019/2/28 创建电子签章--常州
 */
public class BdcDzqzCzCreateServiceImpl implements BdcDzqzCreateService {
    private final Logger logger = LoggerFactory.getLogger(BdcDzqzCzCreateServiceImpl.class);
    @Autowired
    ...
    @Autowired
    BdcDzzzSignConfigService bdcDzzzSignConfigService;
