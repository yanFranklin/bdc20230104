...
import cn.gtmap.realestate.common.core.dozer.converters.gtmap.ZdMcToDmCustomConvert;
 ...
 */
public class DsfZdToBdcDmCustomConvert implements GtmapCompareableCustomConverter {

    private String parameter;

    private static final Logger LOGGER = LoggerFactory.getLogger(DsfZdToBdcDmCustomConvert.class);
