package cn.gtmap.realestate.common.core.dto.exchange.hefei.zwsdk;
...
public class HefeiZwSdkApi extends BaseApp {

    private static final Logger LOGGER = LoggerFactory.getLogger(HefeiZwSdkApi.class);


    public HefeiZwSdkApi() {
        this.apiClient = new ApiClient();
        this.apiClient.init();
        this.appId = "591f23468ddc413dac6142a030d4425e";
        this.appSecret = "9F0656A9A36092DC1B7FA6DBCB5D5182";
    ...
    public ApiResponse apasRegInfo(String apasRegInfo, String attrXml, String formXml) {
        ApiRequest apiRequest = new ApiRequest(HttpConstant.SCHEME_HTTP, Method.POST, "/api/apasRegInfo", SdkConstant.AUTH_TYPE_DEFAULT, SignType.DEFAULT.name(), "79cb6b93c6c346beb3d47b26d9e99839");
    ...
    public ApiResponse apasInfo(String apasRegInfo, String attrXml, String formXml) {
        ApiRequest apiRequest = new ApiRequest(HttpConstant.SCHEME_HTTP, Method.POST, "/api/apasInfo", SdkConstant.AUTH_TYPE_DEFAULT, SignType.DEFAULT.name(),"79cb6b93c6c346beb3d47b26d9e99839");
        initSignStrategy(apiRequest);
    ...
    public ApiResponse acceptInfo(String apasRegInfo, String attrXml) {
        ApiRequest apiRequest = new ApiRequest(HttpConstant.SCHEME_HTTP, Method.POST, "/api/accept", SdkConstant.AUTH_TYPE_DEFAULT, SignType.DEFAULT.name(),"79cb6b93c6c346beb3d47b26d9e99839");
        initSignStrategy(apiRequest);
    ...
    public ApiResponse transactXml(String apasRegInfo, String attrXml, String formXml) {
        ApiRequest apiRequest = new ApiRequest(HttpConstant.SCHEME_HTTP, Method.POST, "/api/transact", SdkConstant.AUTH_TYPE_DEFAULT, SignType.DEFAULT.name(),"79cb6b93c6c346beb3d47b26d9e99839");
        initSignStrategy(apiRequest);
