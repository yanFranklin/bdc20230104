...
function initCfTable() {
    layui.use(['jquery', 'layer', 'element', 'form', 'table', 'laytpl'], function () {
        ...
        var unitTableTitle = [{type: 'checkbox', fixed: 'left'},
            ...
            {field: 'cfbh', title: '查封编号', width: 100},
            {field: 'zl', title: '坐落', minWidth: 300},
            {field: 'cfjg', title: '查封机关', minWidth: 150},
            {field: 'cfwh', title: '查封文号', minWidth: 180},
            {field: 'cfqssj', sort: true, title: '查封起始时间', width: 150,
                templet: function (d) {
                    if (d.cfqssj) {
            ...
            {field: 'cfjssj', sort: true, title: '查封结束时间', width: 150,
                templet: function (d) {
                    if (d.cfjssj) {
            ...
            {field: 'bdcqzh', title: '产权证号', minWidth: 300},
            {field: 'cflx', title: '查封类型', width: 120, templet: '#cflx'},
            {field: 'ywrmc', title: '被查封人', minWidth: 90},
            {field: 'sdzt', title: '锁定类型，锁定原因', minWidth: 200},
            {field: 'zt', title: '状态', minWidth: 100, templet: '#cqzzt', align: "center",fixed:"right"},
            {field: 'cz', title: '操作', width: 300, templet: '#bdcdycz', align: "center",fixed:"right"}
        ];
...
function checkCf(checkdData,sfcj) {
    var selectDataList = [];
