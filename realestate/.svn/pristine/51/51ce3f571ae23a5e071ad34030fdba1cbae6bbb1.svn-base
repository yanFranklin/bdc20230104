...
public final class RsaUtilsHelper {
    private static  org.slf4j.Logger logger = LoggerFactory.getLogger(RsaUtilsHelper.class);
    ...
    public static void printPublicKeyInfo(PublicKey publicKey) {
        ...
        logger.info("Modulus.length="
                + rsaPublicKey.getModulus().bitLength());
        logger.info("Modulus=" + rsaPublicKey.getModulus().toString());
        logger.info("PublicExponent.length="
    ...
    public static void printPrivateKeyInfo(PrivateKey privateKey) {
        ...
        logger.info("----------RSAPrivateKey ----------");
        logger.info("Modulus.length="
                + rsaPrivateKey.getModulus().bitLength());
        logger.info("Modulus=" + rsaPrivateKey.getModulus().toString());
        logger.info("PrivateExponent.length="
                + rsaPrivateKey.getPrivateExponent().bitLength());
        logger.info("PrivatecExponent="
