            ...
            $.ajax({
                ...
                success: function (issh) {
                    ...
                    if (issh == '0') {
                        ...
                        saveDetailLog("XXBL_CK", "信息补录-查看", data);
                        window.open("/realestate-register-ui/view/xxbl/xxblUpdateinfo.html?processInsId=" + data.gzlslid + "&type=update" + "&xmid=" + data.xmid);
                    } else if (issh == '3') {
    ...
    function renderblTable(url, tableId, toolbar) {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: 'bdcqzh', templet: "#bdcqzhTpl", minWidth: 120, title: '不动产权证号', event: 'check'},
