...
public abstract class InitBdcQlrJtcyAbstractService extends InitBdcJtcyBaseAbstractService{
    @Override
    ...
    public List<Object> delete(List<BdcXmDO> list, Boolean sfzqlpbsj, Boolean sfdzbflpbsj, Boolean plDel) throws Exception {
        return deleteJtcy(list,sfzqlpbsj,sfdzbflpbsj,plDel,CommonConstantUtils.QLRLB_QLR);
    }

    @Override
    public InitServiceDTO query(BdcXmDO bdcXmDO, InitServiceDTO initServiceDTO) throws Exception {
        return queryJtcy(bdcXmDO,initServiceDTO,CommonConstantUtils.QLRLB_QLR);
    }
}
