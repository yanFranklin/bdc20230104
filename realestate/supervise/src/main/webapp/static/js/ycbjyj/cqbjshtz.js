...
layui.use(['form', 'jquery', 'laydate', 'element', 'table','formSelects'], function () {
    ...
    table.render({
        elem: '#pageTable',
        toolbar: '#toolbar',
        url: "/realestate-supervise/rest/v1.0/ycbjyj/cqbj",
        title: '超期办件台账',
        ...
        cols: [[
            ...
            {width: 200, sort: false, field: 'gzlcqsc', title: '工作流超期时长'},
            {width: 150, sort: false, field: 'slr', title: '受理人员'},
            {width: 250, sort: false, field: 'ycbjyy', title: '异常办件原因'},
    ...
    function sh(data) {
        ...
        layer.open({
            ...
            area: ['960px', '320px'],
            offset: 'auto',
            content: [ "ycshxx.html?type=cqbj&id=" + data[0].id, 'yes'],
