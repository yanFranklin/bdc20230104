...
public class HlwYwxxServiceImpl implements HlwYwxxService {
     ...
     * 是否设置区县代码查询条件
     */
    @Value("${wwsq.sfszqxdm:false}")
    private Boolean sfszqxdm;
    ...
    public void hxDjxx(JSONObject jsonObject){
        ...
        //更新申请项目
        GxWwSqxmDo gxWwSqxmDo = JSON.parseObject(JSONObject.toJSONString(jsonObject), GxWwSqxmDo.class);
        hlwEntityMapper.updateByJsonEntity(jsonObject, gxWwSqxmDo);
