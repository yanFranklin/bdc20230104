    ...
    $(function () {
        ...
        table.render({
            ...
            parseData: function (res) {
                ...
                //setTableHeight(131);
                var height = $('.bdc-search-content').height();
                setTableHeight(height - 17);
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data) {
                        var xmid = data.xmid;
                        var zl = data.zl;
                        var head = isNotBlank(data.gzldymc) ? data.gzldymc + "权属清册" : "权属清册";
                        $("#head").html(head);
                        $("#zl").html(zl);
        ...
        function convertZdDmToMc(zdname, zdDm) {
            if(undefined != zdDm && null != zdDm && zdData){
