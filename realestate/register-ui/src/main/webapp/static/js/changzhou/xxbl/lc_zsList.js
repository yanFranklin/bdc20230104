        ...
        table.on('tool(blTable)', function (obj) {
            ...
            if (isNullOrEmpty(data.zsid)) {
                ...
                if (layEvent === 'more') {
                    var url = "";
                    if (data.zslx == 1) {
                        url = getContextPath() + "/view/xxbl/lc_zs.html?xmid=" + xmid + "&qllx=" + qllx + "&bdcdyfwlx=" + bdcdyfwlx + "&processInsId=" + processInsId + "&type=" + type+ "&zsid=" + data.zsid;
                    } else {
                        url = getContextPath() + "/view/xxbl/lc_zm.html?xmid=" + xmid + "&qllx=" + qllx + "&bdcdyfwlx=" + bdcdyfwlx + "&processInsId=" + processInsId + "&type=" + type+ "&zsid=" + data.zsid;
                    }
                    window.open(url);
                }
            }
