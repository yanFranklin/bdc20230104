...
layui.use(['jquery', 'form', 'layer'], function () {
    ...
    $(function () {
        ...
        qllx = $.getUrlParam('qllx');
        bdcdyfwlx = $.getUrlParam('bdcdyfwlx');
...
function toNextZsGlPage(data) {
    //根据不动产权证号查询证书信息
    window.location.href = getContextPath() + "/view/xxbl/xxblZsGl.html?xmid=" + xmid +
        "&qllx=" + qllx +
        "&bdcdyfwlx=" + bdcdyfwlx +
