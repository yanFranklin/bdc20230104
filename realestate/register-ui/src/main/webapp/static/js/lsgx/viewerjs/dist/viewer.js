...
(function (global, factory) {
  ...
  var render = {
    ...
    initContainer: function initContainer() {
        this.containerData = {
          width: document.getElementById('seeImgView').clientWidth,
          height: document.getElementById('seeImgView').clientHeight
  ...
  var handlers = {
    ...
    load: function load() {
      ...
      image.style.cssText = 'height:0;' + ('margin-top:' + 15 + 'px;') + 'max-width:none!important;' + 'position:absolute;' + 'width:0;';
