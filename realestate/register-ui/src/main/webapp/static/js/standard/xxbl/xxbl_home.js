...
layui.use(['jquery', 'table', 'layer'], function () {
    ...
    $(function () {
        ...
        function checkQlxx(index) {
            ...
            addModel();
            var bdcGzYzQO = {};
            var gzldyid = $("#process").val();
            bdcGzYzQO.zhbs = gzldyid + "_XZBDCDY";
            bdcGzYzQO.paramList = selectDataList;

            $.ajax({
                url: getContextPath() + '/rest/v1.0/blxx/blxz/zx?gzldyid=' + gzldyid,
                type: 'POST',
                dataType: 'json',
                contentType: "application/json;charset=UTF-8",
