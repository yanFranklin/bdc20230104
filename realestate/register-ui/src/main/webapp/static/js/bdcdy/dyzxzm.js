...
layui.use(['jquery', 'table', 'laypage', 'form'], function () {
    ...
    $(function () {
        ...
        var _colsParam = [
            ...
            {field: "qlr", title: "他项权人", align: "center"},
            {field: "bdcqzh", title: "他项权证号", align: "center"}
        ];
        // 查询的结果
        var data = [];
        $.ajax({
        ...
        form.on('submit(printBtn)', function (data) {
            var modelUrl = dyzxzmModelUrl;
            var dataUrl = getIP() + "/realestate-register-ui/rest/v1.0/print/bdcdy/" + processInsId + "/dyzxzm/xml";
