    ...
    $(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $(".mjdw").html(isNullOrEmpty(bdcDyawMjDTO.mjdwmc) ?"平方米":bdcDyawMjDTO.mjdwmc);
                getXmxx();
            }
        });
        ...
        table.render({
            ...
            parseData: function (res) {
                ...
                if (xsdy != "n" && (readOnly || !isNullOrEmpty(formStateId))) {
                    getStateById(readOnly, formStateId, "dyawqdlq");
                }
        ...
        // 存储打印配置的sessionKey，当前页的打印类型
            var dylxArr = ["dyawqdlq", "ydyawqdlq", "ydyawqdlq_1", "ygDyawqdlq", "ygYdyawqdlq"];
        ...
        function printDyawqd() {
            ...
            var dylx;
            if (sfscql && qllx == commonDyaq_qllx) {// 抵押物清单(林权)
                dylx = "dyawqdlq";
                //modelUrl = dyawqdModelUrl;
            } else if (!sfscql && qllx == commonDyaq_qllx) {// 原抵押物清单(林权)
                dylx = "ydyawqdlq";
                if (dyabg && dyabg > 0) {
                    dylx = "ydyawqdlq_" + dyabg;
                }
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data) {
                        ...
                        $("#dywzmj").html(parseFloat(bdcDyawMjDTO.dyawzmj).toFixed(2));
                    }
                }
            });
        }
