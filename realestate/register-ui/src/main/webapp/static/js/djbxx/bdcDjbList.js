...
layui.use(['form', 'table', 'jquery'], function () {
    ...
    $(function () {
        ...
        if (isNotBlank(type) && type === "xzlc") {
            //如果是修正流程，gzlslid需要获取当前修正流程的上一手数据
            getReturnData("/rest/v1.0/djbxx/xzlc", {gzlslid: processInsId}, "GET", function (data) {
                if (data) {
                    processInsId = data;
                }
            }, function (xhr) {
        ...
        table.on('tool(dataTable)', function (obj) {
            ...
            switch (obj.event) {
                ...
                case 'djdcb':
                    ...
                    window.open('/building-ui/djdcb/initview?bdcdyh=' + data.bdcdyh + "&qjgldm=" + data.qjgldm + "&bdcqzh=" + bdcqzh + "&type=1" + "&slbh=" + data.slbh);
                    break;
                case 'lpb':
                    /**
                    ...
                    if (data.bdclx == '2' || data.bdclx == '4' || data.bdclx == '10') {
                        window.open('/building-ui/lpb/view?code=bdcres&bdcdyh=' + data.bdcdyh +"&qjgldm="+data.qjgldm);
                    } else {
                ...
                case 'ompRedirect':
                    ...
                    break;
                case 'lsgx':
                    window.open('/realestate-register-ui/view/lsgx/bdcdyDjLsgx.html?bdcdyh=' + data.bdcdyh + '&hideDjbBtn=true'+'&tzym=bdcDjbList.html');
                    break;
                case 'fcda':
