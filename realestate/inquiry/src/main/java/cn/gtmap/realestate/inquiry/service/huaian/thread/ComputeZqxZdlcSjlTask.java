 ...
 */
public class ComputeZqxZdlcSjlTask implements Runnable {

    private static final Logger LOGGER = LoggerFactory.getLogger(ComputeZqxZdlcSjlTask.class.getName());
    ...
    public ComputeZqxZdlcSjlTask(GzltjQO gzltjQO, List<BdcZqxGzltjXmxxVO> bdcZqxGzltjXmxxVOList, BdcGzltjXmxxMapper bdcGzltjXmxxMapper){
    ...
    @Override
    public void run() {
        if(gzltjQO ==null || StringUtils.isBlank(gzltjQO.getProcess())){
            return;
        }
        ...
        LOGGER.info("计算周期性重点流程工作量任务结束，耗时：{}， 查询参数：{}" , System.currentTimeMillis() - startTime, JSON.toJSONString(param));
    }
            ...
            if(MapUtils.isNotEmpty(resultMap)){
                ...
                while (bdcZqxGzltjXmxxVOIterator.hasNext()) {
                    ...
                    if(StringUtils.isNotBlank(bdcZqxGzltjXmxxVO.getRyid()) && resultMap.containsKey(bdcZqxGzltjXmxxVO.getRyid())){
                        bdcZqxGzltjXmxxVO.setZdlcgzl(resultMap.get(bdcZqxGzltjXmxxVO.getRyid()));
                    }
                }
            }
            ...
            if(MapUtils.isNotEmpty(resultMap)){
                ...
                while (bdcZqxGzltjXmxxVOIterator.hasNext()) {
                    ...
                    if(StringUtils.isNotBlank(bdcZqxGzltjXmxxVO.getBmdm()) && resultMap.containsKey(bdcZqxGzltjXmxxVO.getBmdm())){
                        bdcZqxGzltjXmxxVO.setZdlcgzl(resultMap.get(bdcZqxGzltjXmxxVO.getBmdm()));
                    }
                }
            }
        }
