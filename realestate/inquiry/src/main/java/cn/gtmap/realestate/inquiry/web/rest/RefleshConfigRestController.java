...
import cn.gtmap.realestate.common.core.service.rest.refleshconfig.InquiryAppRefleshConfigRestService;
 ...
 * @Description:
 */
public class RefleshConfigRestController implements InquiryAppRefleshConfigRestService {
    @Autowired
