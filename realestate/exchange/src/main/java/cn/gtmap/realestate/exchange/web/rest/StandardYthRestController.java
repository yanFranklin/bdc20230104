 ...
 * @description 一体化相关服务-原盐城服务，地址提取为标准版
 */
@OpenController(consumer = "一体化相关服务")
@RestController
@RequestMapping("/realestate-exchange/rest/v1.0")
@Api(tags = "一体化相关服务")
public class StandardYthRestController {

    private static final Logger LOGGER = LoggerFactory.getLogger(StandardYthRestController.class);
     ...
     */
    @OpenApi(apiDescription = "一体化撤件请求", apiName = "", openLog = false)
    @PostMapping("/yth/cancel")
    @DsfLog(logEventName = "一体化撤件请求", dsfFlag = "", requester = "", responser = "BDC")
     ...
     * @description 接收一体化平台收费信息
     */
    @OpenApi(apiDescription = "接收一体化平台收费信息", apiName = "", openLog = false)
    @PostMapping("/yth/jssfxx")
    @DsfLog(logEventName = "接收一体化平台收费信息", dsfFlag = "YTH", requester = "", responser = "BDC")
     ...
     * @return
     * @author <a href="mailto:liaoxiang@gtmap.cn">liaoxiang</a>
     * @description 一体化平台申请创建业务接口
     */
    @OpenApi(apiDescription = "一体化平台申请创建业务接口", apiName = "", openLog = false)
    @PostMapping("/yth/jssqxxcj")
    @DsfLog(logEventName = "一体化平台申请创建业务接口", dsfFlag = "YTH", requester = "", responser = "BDC")
     ...
     */
    @OpenApi(apiDescription = "一体化推送受理信息", apiName = "", openLog = false)
    @PostMapping("/yth/tsslxx")
    @DsfLog(logEventName = "一体化推送受理信息", dsfFlag = "YTH", requester = "", responser = "BDC")
     ...
     */
    @ResponseBody
    @PostMapping("/yth/get/dzzz/and/zdxx")
     ...
     * @author <a href="mailto:yaoyi@gtmap.cn">yaoyi</a>
     */
    @OpenApi(apiDescription = "一体化推送审核信息", apiName = "", openLog = false)
    @PostMapping("/yth/tsshxx")
    @DsfLog(logEventName = "一体化推送审核信息", dsfFlag = "YTH", requester = "", responser = "BDC")
    ...
    @OpenApi(apiDescription = "一体化推送发证信息", apiName = "", openLog = false)
    @PostMapping("/yth/tsfzxx")
    @DsfLog(logEventName = "一体化推送发证信息", dsfFlag = "YTH", requester = "", responser = "BDC")
     ...
     * @author <a href="mailto:huangjian@gtmap.cn">huangjian</a>
     */
    @OpenApi(apiDescription = "登记删除业务，通知一体化", openLog = false)
    @PostMapping("/yth/deletettzyth")
    @DsfLog(logEventName = "登记删除业务，通知一体化", dsfFlag = "YTH", requester = "", responser = "BDC")
