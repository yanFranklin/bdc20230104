package cn.gtmap.realestate.exchange.util.constants;
...
public class Constants {
     ...
     * 上报服务器检测状态任务名
     */
    public static final String ACCESS_SBFWQ_JOB = "accessSbfwqTaskJob";


    public static final String ACCESS_BCSB_JOB = "accessBcsbLock";
    ...
    /**
     * 一张网数据推送定时任务定时任务名称（redis分布式事务锁用）
     */
    public static final String YZW_SHAREDATA_TASK_JOB_NAME = "yzwShareDataTaskJob";

    /**
     * 定时一张网验证定时任务定时任务名称（redis分布式事务锁用）
     */
    public static final String YZW_CHECK_TASK_JOB_NAME = "yzwCheckTaskJob";
    ...
    public static final String FAIL_CODE_1 = "1";
    ...
    //权利人顺序号
    public static final Integer QLR_SXH1 = 1;
    ...
    public static final String DJXL = "djxl";
    public static final String YHFS = "yhfs";
    public static final String HXJG = "hxjg";
    public static final String DJLX = "djlx";
    public static final String FWYT = "fwyt";
    public static final String FWJG = "fwjg";
    public static final String JBLX = "jblx";
    public static final String JZDLX = "jzdlx";
    public static final String JXXZ = "jxxz";
    public static final String JZXLB = "jzxlb";
    public static final String JZXWZ = "jzxwz";
    public static final String XMXZ = "xmxz";
    public static final String HDYT = "wjmhdyt";
    public static final String HYSYLXA = "hysylxa";
    public static final String HYSYLXB = "hysylxb";
    ...
    public static final String CXBH = "cxbh";
    public static final String FWLB = "fwlb";

    //安徽省政务-申报登记接口标识  申报登记，受理节点，办结节点
    public static final String SBDJ = "sbdj";
    public static final String SBDJ_SL = "sbdj_sl";
    public static final String SBDJ_BJ = "sbdj_bj";

    //上报超时天数
    public static final int DAY_180 = 180;

    public static final String WXJJ_REDIS_LOCK_NAME = "WXJJ_REDIS_LOCK_NAME";

    // 省级查询-批量查询
    public static final String SJCX_PLCX = "PLCX";
    // 省级查询-实时查询
    public static final String SJCX_SSCX = "SSCX";
