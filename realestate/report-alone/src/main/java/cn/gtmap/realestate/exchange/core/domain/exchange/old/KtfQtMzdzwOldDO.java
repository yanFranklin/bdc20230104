 ...
 */
@XmlRootElement(name = "KTF_QT_MZDZW")
@XmlAccessorType(XmlAccessType.NONE)
public class KtfQtMzdzwOldDO implements Serializable {

    private String ysdm = "6001990100";//要素代码
    private String bdcdyh;//不动产单元号
    private Integer bsm;//标识码
    private String zdzhdm;//宗地宗海代码
    private String mzdzwlx;//面状定着物类型
