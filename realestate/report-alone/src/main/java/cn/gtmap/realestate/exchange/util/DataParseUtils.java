...
public class DataParseUtils {
    ...
    public static <T> Object parseType(String str) {
        ...
        // List<Integer>类型
        try {
            return new Gson().fromJson(str, new TypeToken<List<Integer>>() {
            }.getType());
        } catch (Exception e) {
            // do nothing
        }
        ...
        try {
            return new Gson().fromJson(str, new TypeToken<List<Map>>() {
            }.getType());
        } catch (Exception e) {
            // do nothing
        }
        ...
        // Map类型
        try {
            return new Gson().fromJson(str, new TypeToken<Map>() {
            }.getType());
        } catch (Exception e) {
            // do nothing
        }
