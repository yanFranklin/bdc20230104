 ...
 */
package cn.gtmap.realestate.exchange.core.dozer;
  ...
  /* End of Mapper Interface Implementation */
    ...
    private <T> T mapGeneral(Object srcObj, final Class<T> destClass, final T destObj, final String mapId) {
        ...
        try {
            ...
            if (converterClass != null) {
                return (T) mapUsingCustomConverter(converterClass, srcObj.getClass(), srcObj, destType, result, null, true, srcObj, result);
            }
    ...
    private void map(ClassMap classMap, Object srcObj, Object destObj, boolean bypassSuperMappings, List<String> mappedParentFields, String mapId) {
        ...
        Class<?> converterClass = MappingUtils.findCustomConverter(converterByDestTypeCache, classMap.getCustomConverters(), srcClass,
                destClass);
        if (converterClass != null) {
            mapUsingCustomConverter(converterClass, srcClass, srcObj, destClass, destObj, null, true, srcObj, destObj);
            return;
        }
        ...
        if (!MappingUtils.isBlankOrNull(fieldMapping.getCustomConverterId())) {
            if (customConverterObjectsWithId != null && customConverterObjectsWithId.containsKey(fieldMapping.getCustomConverterId())) {
                ...
                destFieldValue = mapUsingCustomConverterInstance(customConverterObjectsWithId.get(fieldMapping.getCustomConverterId()),
                        srcFieldClass, srcFieldValue, destFieldType, destObj, fieldMapping, false, srcObj, destObj);
            } else {
            ...
            destFieldValue = mapUsingCustomConverter(MappingUtils.loadClass(fieldMapping.getCustomConverter()), srcFieldClass,
                    srcFieldValue, destFieldType, destObj, fieldMapping, false, srcObj, destObj);
        }
    ...
    private Object mapOrRecurseObject(Object srcObj, Object srcFieldValue, Class<?> destFieldType, FieldMap fieldMap, Object destObj) {
        ...
        // #1563795
        if (converterClass != null) {
            return mapUsingCustomConverter(converterClass, srcFieldClass, srcFieldValue, destFieldType, destObj, fieldMap, false, srcObj, destObj);
        }
        ...
        if (isSrcFieldClassSupportedMap && isDestFieldTypeSupportedMap) {
            return mapMap(srcObj, (Map<?, ?>) srcFieldValue, fieldMap, destObj,destFieldType);
        }
    ...
    private Object mapCollection(Object srcObj, Object srcCollectionValue, FieldMap fieldMap, Object destObj) {
        ...
        // way to handle this?
        if (StringUtils.equals(destCollectionType.getName(), Collection.class.getName())) {
    ...
    private Object mapMap(Object srcObj, Map srcMapValue, FieldMap fieldMap, Object destObj,Class<?> destFieldType) {
        Map result;
        ...
        // 原有逻辑：当源与目标的对照类型都为键值对类型，则全部对照，不读取配置的map-id对应配置
        // liyinqiao 2020-02-14 修改为当field配置map-id，使用默认对照方式（读取map-id）处理
        if(StringUtils.isNotBlank(fieldMap.getMapId())){
            return mapCustomObject(fieldMap, destObj, destFieldType, srcMapValue);
        }
    ...
    private Object mapUsingCustomConverterInstance(CustomConverter converterInstance, Class<?> srcFieldClass, Object srcFieldValue,
                                                   Class<?> destFieldClass, Object existingDestFieldValue, FieldMap fieldMap, boolean topLevel, Object srcObject, Object destObject) {
        ...
        Object result;
        if (converterInstance instanceof GtmapCompareableCustomConverter) {
            GtmapCompareableCustomConverter theConverter = (GtmapCompareableCustomConverter) converterInstance;
            ...
            if (srcObject != null) {
                theConverter.setSourceObject(srcObject);
            }
            if (destObject != null) {
                theConverter.setDestinationObject(destObject);
            }
    ...
    private Object mapUsingCustomConverter(Class<?> customConverterClass, Class<?> srcFieldClass, Object srcFieldValue,
        ...
        return mapUsingCustomConverterInstance(converterInstance, srcFieldClass, srcFieldValue, destFieldClass, existingDestFieldValue,
                fieldMap, topLevel, srcObject, destObject);
    }
