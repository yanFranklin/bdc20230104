...
public class QlfQlCfdjDO implements Serializable, AccessData {

    private String ysdm = "6002040300";//要素代码
    ...
    @Id
    private String ywh;
    @ApiModelProperty(value = "查封机关非空")
    private String cfjg;
    @ApiModelProperty(value = "查封类型查封类型字典表")
    private String cflx;
    @ApiModelProperty(value = "查封文件")
    private String cfwj;
    @ApiModelProperty(value = "查封文号非空")
    private String cfwh;
    @JSONField(format = "yyyy-MM-dd HH:mm:ss")
    @ApiModelProperty(value = "查封起始时间非空")
    private Date cfqssj;
    @JSONField(format = "yyyy-MM-dd HH:mm:ss")
    @ApiModelProperty(value = "查封结束时间非空")
    private Date cfjssj;
    @ApiModelProperty(value = "查封范围非空")
    private String cffw;
    ...
    public void setCxlxmc(String cxlxmc) {
        this.cxlxmc = cxlxmc;
    }
