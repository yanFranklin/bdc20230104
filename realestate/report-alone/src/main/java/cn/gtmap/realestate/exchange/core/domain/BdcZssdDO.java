...
public class BdcZssdDO {
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("BdcZssdDO{");
        sb.append("zssdid='").append(zssdid).append('\'');
        ...
        sb.append(", sdzt=").append(sdzt);
        sb.append(", sdyy='").append(sdyy).append('\'');
        sb.append(", sdr='").append(sdr).append('\'');
        sb.append(", sdrid='").append(sdrid).append('\'');
        sb.append(", sdsj=").append(sdsj);
        sb.append(", jsr='").append(jsr).append('\'');
        sb.append(", jsrid='").append(jsrid).append('\'');
        sb.append(", jssj=").append(jssj);
        sb.append(", jsyy='").append(jsyy).append('\'');
        sb.append(", bz='").append(bz).append('\'');
        sb.append(", sdsqjg='").append(sdsqjg).append('\'');
        sb.append(", sdsqwh='").append(sdsqwh).append('\'');
        sb.append(", gzldymc='").append(gzldymc).append('\'');
        sb.append(", sjrymc='").append(sjrymc).append('\'');
        sb.append(", sjryzjh='").append(sjryzjh).append('\'');
