package cn.gtmap.realestate.natural.resource;
...
@MapperScan("cn.gtmap.realestate.natural.resource.core.mapper")
@DependsOn("automaticLoadingConfig")
public class NaturalResourceApp {

    public static void main(String[] args) {
        SpringApplication.run(NaturalResourceApp.class, args);
    }
