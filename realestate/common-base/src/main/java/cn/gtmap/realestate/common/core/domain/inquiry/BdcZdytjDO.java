 ...
 * @description: 自定义统计表
 */
@Api(value = "BdcZdytjDO", description = "自定义统计表")
@Table(name = "bdc_zdytj")
public class BdcZdytjDO {
    ...
    public String getPzjs() {
        return pzjs;
    }

    public void setPzjs(String pzjs) {
        this.pzjs = pzjs;
    }
