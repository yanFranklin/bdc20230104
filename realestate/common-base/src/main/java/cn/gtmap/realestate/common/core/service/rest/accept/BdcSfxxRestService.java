...
public interface BdcSfxxRestService {
     ...
     **/
    @PostMapping("/realestate-accept/rest/v1.0/sfxx/getXfjyxxcs")
     ...
     * @description 保存交易信息
     **/
    @PostMapping("/realestate-accept/rest/v1.0/sfxx/saveJyxx")
    void saveJyxx(@RequestParam(value = "output") String output,
                  @RequestParam(value = "gzlslid") String gzlslid,
     ...
     **/
    @PostMapping("/realestate-accept/rest/v1.0/sfxx/gkjhZfJyCs")
     ...
     **/
    @PostMapping("/realestate-accept/rest/v1.0/sfxx/drcxjyCs")
     ...
     * @description 退货交易参数
     **/
    @PostMapping("/realestate-accept/rest/v1.0/sfxx/thjyCs")
     ...
     * @return java.lang.Object
     * @author <a href="mailto:xuzhou@gtmap.cn">xuzhou</a>
     * @date 2022/8/22 16:11
     * @description 广开聚合退货交易参数
     **/
    @PostMapping("/realestate-accept/rest/v1.0/sfxx/gkjhthjyCs")
     ...
     * @description 重打印参数
     **/
    @PostMapping("/realestate-accept/rest/v1.0/sfxx/rePrintJyCs")
