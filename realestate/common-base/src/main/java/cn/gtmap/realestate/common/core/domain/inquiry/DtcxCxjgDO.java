...
public class DtcxCxjgDO {
    ...
    @ApiModelProperty("省略号位置(1：前省略 2:后省略)")
    private Integer slhwz;
    ...
    public void setFxkpd(String fxkpd) {
        this.fxkpd = fxkpd;
    }

    public Integer getSlhwz() {
        return slhwz;
    }

    public void setSlhwz(Integer slhwz) {
        this.slhwz = slhwz;
    }

    public Integer getDecrypt() {
        return decrypt;
    }

    public void setDecrypt(Integer decrypt) {
        this.decrypt = decrypt;
    }

    public String getDclk() {
        return dclk;
    }

    public void setDclk(String dclk) {
        this.dclk = dclk;
    }

    @Override
    public String toString() {
        final StringBuilder sb = new StringBuilder("DtcxCxjgDO{");
        sb.append("jgid='").append(jgid).append('\'');
        sb.append(", cxid='").append(cxid).append('\'');
        sb.append(", cxdh='").append(cxdh).append('\'');
        sb.append(", jgzdid='").append(jgzdid).append('\'');
        sb.append(", jgzdname='").append(jgzdname).append('\'');
        sb.append(", mrxs='").append(mrxs).append('\'');
        sb.append(", jgtype='").append(jgtype).append('\'');
        sb.append(", zdid='").append(zdid).append('\'');
        sb.append(", lk='").append(lk).append('\'');
        sb.append(", dqfs='").append(dqfs).append('\'');
        sb.append(", dw='").append(dw).append('\'');
        sb.append(", priority=").append(priority);
        sb.append(", sortable=").append(sortable);
        sb.append(", url='").append(url).append('\'');
        sb.append(", fxkpd='").append(fxkpd).append('\'');
        sb.append(", dclk='").append(dclk).append('\'');
        sb.append(", slhwz=").append(slhwz);
        sb.append('}');
        return sb.toString();
    }
}
