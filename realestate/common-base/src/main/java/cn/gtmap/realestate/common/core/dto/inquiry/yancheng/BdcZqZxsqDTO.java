 ...
 * @description 盐城征迁注销申请
 */
public class BdcZqZxsqDTO {
    ...
    @ApiModelProperty(value = "注销申请人")
    private String zxsqr;

    @ApiModelProperty(value = "注销申请人ID")
    ...
    @ApiModelProperty(value = "角色编码，英文逗号间隔")
    ...
    public void setZxsqrid(String zxsqrid) {
        this.zxsqrid = zxsqrid;
    }
    ...
    public void setZxsqsj(Date zxsqsj) {
        this.zxsqsj = zxsqsj;
    }
