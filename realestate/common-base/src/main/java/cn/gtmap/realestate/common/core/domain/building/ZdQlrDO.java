 ...
 */
@Table(name = "zd_qlr")
public class ZdQlrDO {
	/**
	 * 主键
	 */
	@Id
	@ApiModelProperty(value = "主键")
	private String zdQlrIndex;
	/**
	 * 调查主表主键
	 */
	...
	public String getZdQlrIndex() {
		return zdQlrIndex;
	}

	public void setZdQlrIndex(String zdQlrIndex) {
		this.zdQlrIndex = zdQlrIndex;
	}
