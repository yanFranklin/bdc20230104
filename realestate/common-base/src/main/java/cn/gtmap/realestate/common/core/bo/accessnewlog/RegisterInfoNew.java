 ...
 * @description 具体登簿量节点信息
 */
@XmlType(
        name = "registerInfo",
        propOrder = {"totalNum", "firstReg", "transferReg", "changeReg", "logoutReg", "riviseReg", "dissentingReg", "advanceReg",
                "seizeReg", "otherReg", "businessTypeCount"}
)
@XmlRootElement(
        name = "RegisterInfo"
)
