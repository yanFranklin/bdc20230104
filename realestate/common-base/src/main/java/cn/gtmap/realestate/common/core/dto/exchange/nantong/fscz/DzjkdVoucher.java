 ...
 */
@XmlType(name = "Voucher", propOrder = {"admDivCode", "payCode", "billDate", "chgAgenCode", "chgAgenName", "payerName", "payerAcct",
        "payerOpBk", "amt", "oriAmt", "delayAmt", "payStats", "recAcctType", "recName", "recAcct", "recAcctReal", "recOpBk", "recBankNo",
        "isInterBank", "payInfo", "memo", "crcCode", "mobilePhone", "payerCreditCode", "recCreditCode", "operatorCode", "operatorName", "hold1", "hold2"})
@XmlRootElement(name = "Voucher")
@XmlAccessorType(XmlAccessType.PROPERTY)
public class DzjkdVoucher {
