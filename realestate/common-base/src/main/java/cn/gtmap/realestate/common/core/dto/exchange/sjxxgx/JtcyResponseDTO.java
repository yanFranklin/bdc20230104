 ...
 * @description 宣城家庭成员查询 响应结果
 */
public class JtcyResponseDTO {
    // 出生日期
    private String CSRQ;
    // 国籍
    private String GJ;
    ...
    public void setNVXM(String NVXM) {
        this.NVXM = NVXM;
    }
    ...
    public void setNVZJH(String NVZJH) {
        this.NVZJH = NVZJH;
    }
    ...
    public void setNZJH(String NZJH) {
        this.NZJH = NZJH;
    }
