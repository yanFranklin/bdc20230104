 ...
 * @description 在建工程抵押状态
 */
public class ZjgcdyStatus extends StatusDecorator {
     ...
     * @description 构造函数
     */
    public ZjgcdyStatus(StatusResource resource) {
        super(resource);
    }
    ...
    public Integer getStatusCount() {
        if (this.sSjBdcdyhxsztDO != null) {
            return this.sSjBdcdyhxsztDO.getXszjgcdycs();
        }
        return 0;
    }
