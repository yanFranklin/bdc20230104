 ...
 * @description 存量房可售状态
 */
public class ClfksStatus extends StatusDecorator {
     ...
     * @description 构造函数
     */
    public ClfksStatus(StatusResource resource) {
        super(resource);
    }
    ...
    public Integer getStatusCount() {
        if (this.sSjBdcdyhxsztDO != null) {
            return this.sSjBdcdyhxsztDO.getClfks();
        }
        return 0;
    }
