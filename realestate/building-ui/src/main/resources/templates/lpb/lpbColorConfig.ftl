...
<head>
    ...
    <script src="../js/lpb/configColor.js?v=2020-05-31112234"></script>
</head>
<body>
<div class="bdc-container">
    ...
    <div class="bdc-color-module">
        ...
        <div class="bdc-config-color clear">
            <div class="bdc-color-list">
                <div class="bdc-one-color bdc-wdj-config"></div>未登记
            </div>
            <div class="bdc-color-list">
                <div class="bdc-one-color bdc-yg-config"></div>已预告
            </div>
            <div class="bdc-color-list">
                <div class="bdc-one-color bdc-dj-config"></div>已登记
            </div>
            <div class="bdc-color-list">
                <div class="bdc-one-color bdc-zx-config"></div>已注销
            </div>
        </div>
    </div>
    <div class="bdc-color-module">
        ...
        <div class="bdc-config-color clear">
            <div class="bdc-color-list">
                <div class="bdc-one-color bdc-ks-config"></div>可售
            </div>
            <div class="bdc-color-list">
                <div class="bdc-one-color bdc-ys-config"></div>已售
            </div>
            <div class="bdc-color-list">
                <div class="bdc-one-color bdc-cq-config"></div>草签
            </div>
            <div class="bdc-color-list">
                <div class="bdc-one-color bdc-wg-config"></div>物管用房
            </div>
            <div class="bdc-color-list">
                <div class="bdc-one-color bdc-az-config"></div>安置房
            </div>
            <div class="bdc-color-list">
                <div class="bdc-one-color bdc-bl-config"></div>保留房
            </div>
            <div class="bdc-color-list">
                <div class="bdc-one-color bdc-fpt-config"></div>非普通住宅
            </div>
        </div>
    </div>
    <div class="bdc-color-module">
        ...
        <div class="bdc-config-color clear">
            <div class="bdc-color-list">
                <div class="bdc-one-color bdc-zjgcdy-config"></div>在建工程抵押
            </div>
            <div class="bdc-color-list">
                <div class="bdc-one-color bdc-ydya-config"></div>预抵押
            </div>
            <div class="bdc-color-list">
    ...
    <div class="bdc-color-module">
        ...
        <div class="bdc-config-color clear">
            <div class="bdc-color-list">
                <div class="bdc-one-color bdc-ba-config"></div>备案
            </div>
        </div>
    </div>
    <!--颜色选择区  结束-->
...
<script type="text/html" id="statusTpl"></script>
</html>