...
import cn.gtmap.realestate.common.core.service.rest.refleshconfig.InitAppRefleshConfigRestService;
 ...
 * @Description:
 */
public class RefleshConfigRestController implements InitAppRefleshConfigRestService {
    @Autowired
