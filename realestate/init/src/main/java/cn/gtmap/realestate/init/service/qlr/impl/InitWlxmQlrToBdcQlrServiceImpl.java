 ...
 * @description 初始化外联项目权利人到权利人
 */
@Service
public class InitWlxmQlrToBdcQlrServiceImpl extends InitBdcQlrAbstractService {

    @Override
    public String getVal() {
        return Constants.QLRSJLY_WLXM_QLR.toString();
    }
            ...
            if(CollectionUtils.isNotEmpty(listLsgx)){
                for(BdcXmLsgxDO bdcXmLsgxDO:listLsgx){
                    ...
                    if(StringUtils.isNotBlank(bdcXmLsgxDO.getYxmid()) && CommonConstantUtils.SF_S_DM.equals(bdcXmLsgxDO.getWlxm())){
                        ...
                        bdcQlrDOList = bdcQlrService.inheritYxmBdcQlr(bdcXmLsgxDO.getYxmid(),initServiceQO.getXmid(), CommonConstantUtils.QLRLB_QLR);
                        break;
                    }
                }
            }
