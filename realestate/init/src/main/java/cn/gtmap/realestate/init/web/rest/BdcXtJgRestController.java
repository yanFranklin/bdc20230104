...
public class BdcXtJgRestController extends BaseController implements BdcXtJgRestService {

    @Autowired
    private BdcXtJgService bdcXtJgService;

    /**
     * 非税月结银行名称集合
     */
    @Value("#{'${fs.yjyhmc:}'.split(',')}")
    private List<String> yjyhmcList;
    ...
    public List<BdcXtJgDO> listBdcXtJg(@RequestParam("jglb") Integer jglb) {
        return bdcXtJgService.listBdcXtJg(jglb);
    }
    ...
    public BdcXtJgDO queryJgByJgmc(@RequestParam(value = "jgmc") String jgmc,@RequestParam(value = "jglb",required = false) String jglb) {
        return bdcXtJgService.queryJgByJgMc(jgmc,jglb);
    }
    ...
    public List<BdcXtJgDO> queryBdcXtJg(@RequestBody BdcXtJgDO bdcXtJgDO) {
        return bdcXtJgService.listBdcXtJg(bdcXtJgDO);
    }
    ...
    public List<BdcXtJgDO> listAyjsBdcXtJg() {
        return bdcXtJgService.listAyjsBdcXtJg(null);
    }
	...
	public List<BdcXtJgDO> listAyjsBdcXtJgYhmc(@RequestParam("yhmc")String yhmc) {
		return bdcXtJgService.listAyjsBdcXtJg(yhmc);
	}
    ...
    public List<BdcXtJgDO> listAyjsBdcXtJgYhmcLike(@RequestParam("yhmc")String yhmc) {
        return bdcXtJgService.listAyjsBdcXtJgLike(yhmc);
    }
    ...
    public List<BdcJgLzrGxDO> queryJgLzrByJgid(@RequestParam(value = "jgid") String jgid) {
        return bdcXtJgService.queryJgLzrByJgid(jgid);
    }
    ...
    public Page<BdcJgLzrGxDTO> queryJgLzrByPage(Pageable pageable, String bdcXtjgLzrQOJSON) {
        ...
        return bdcXtJgService.queryJgLzrByPage(pageable,bdcXtjgLzrQO);
    }
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "bdcXtjgQOJSON", value = "参数JSON",
                    dataType = "String", paramType = "query"),
            @ApiImplicitParam(name = "pageable", value = "分页参数",
                    dataType = "Page", paramType = "body")})
    public Page<BdcXtJgDTO> queryJgByPage(Pageable pageable, String bdcXtjgQOJSON) {
        BdcXtjgQO bdcXtjgQO = new BdcXtjgQO();
        if (StringUtils.isNotBlank(bdcXtjgQOJSON)) {
            bdcXtjgQO = JSONObject.parseObject(bdcXtjgQOJSON, bdcXtjgQO.getClass());
        }
        return bdcXtJgService.queryJgByPage(pageable,bdcXtjgQO);
    }
    ...
    public void deleteJglzr(@PathVariable("gxid") String gxid) {
         bdcXtJgService.deleteJglzr(gxid);
    ...
    public BdcJgLzrGxDO insertBdcJgLzr(@RequestBody BdcJgLzrGxDO bdcJgLzrGxDO) {
        bdcXtJgService.insertBdcLzr(bdcJgLzrGxDO);
        return bdcJgLzrGxDO;
    }
    ...
    public void batchModifyXtJgSfky(@RequestBody List<String> yhmcList,  @PathVariable(name ="sfky") int sfky) {
        bdcXtJgService.batchModifyXtJgSfky(yhmcList, sfky);
    }
    ...
    public BdcXtJgDO insertBdcJg(@RequestBody BdcXtJgDO bdcXtJgDO) {
        bdcXtJgService.insertBdcXtJg(bdcXtJgDO);
        return bdcXtJgDO;
    }
    ...
    public List<BdcXtJgDO> queryBatchBdcXtJg(@RequestBody List<String> jgmclist) {
        List<BdcXtJgDO> bdcXtJgDOList= bdcXtJgService.queryBatchBdcXtJg(jgmclist);
        return bdcXtJgDOList;
    }

    @Override
    public List<String> listYjyhmc() {
        return yjyhmcList;
    }
