 ...
 * @description 从原项目加载数据到构建筑物所有权 测试
 */
...
public class InitYxmToBdcGjzwsyqServiceImplTest {
    @Autowired
    private InitYxmToBdcGjzwsyqServiceImpl initYxmToBdcGjzwsyqService;

    @Transactional(transactionManager = "transactionManager")
    @Test
    @Rollback
    @DatabaseSetup(value = "/data/InitYxmToBdcGjzwsyqSetup-data.xml")
    public void initQlxx() throws Exception {
        ...
        BdcGjzwsyqDO bdcGjzwsyqDO = (BdcGjzwsyqDO) initYxmToBdcGjzwsyqService.initQlxx(initServiceQO);
        ...
        Assert.assertEquals("tdhysyqr",bdcGjzwsyqDO.getTdhysyqr());
        Assert.assertEquals("235.33",bdcGjzwsyqDO.getTdhysymj().toString());
        Assert.assertEquals(sdf.parse("2018-11-13 01:45:54"),bdcGjzwsyqDO.getTdhysyqssj());
        Assert.assertEquals(sdf.parse("2088-11-13 01:45:54"),bdcGjzwsyqDO.getTdhysyjssj());
        Assert.assertEquals("23",bdcGjzwsyqDO.getGjzwlx().toString());
        Assert.assertEquals("312",bdcGjzwsyqDO.getGjzwghyt());
        Assert.assertEquals("423.33",bdcGjzwsyqDO.getGjzwmj().toString());
        Assert.assertEquals("2018-11-13 1:45:54",bdcGjzwsyqDO.getJgsj());
