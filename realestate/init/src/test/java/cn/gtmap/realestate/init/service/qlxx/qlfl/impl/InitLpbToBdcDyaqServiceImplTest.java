...
public class InitLpbToBdcDyaqServiceImplTest {
    @Autowired
    private InitLpbToBdcDyaqServiceImpl initLpbToBdcDyaqService;
    ...
    public void initQlxx() throws Exception {
        ...
        BdcDyaqDO bdcDyaqDO = (BdcDyaqDO) initLpbToBdcDyaqService.initQlxx(initServiceQO);
