...
import cn.gtmap.realestate.init.service.qlr.impl.InitLpbToBdcYwrServiceImpl;
 ...
 * @description 获取权籍权利人做不动产义务人服务单元测试
 */
...
public class InitLpbToBdcYwrServiceImplTest {
    @Autowired
    private InitLpbToBdcYwrServiceImpl initLpbToBdcYwrService;
    @Autowired
    ...
    public void initQlr(){
        ...
        List<BdcQlrDO> bdcQlrDOList = initLpbToBdcYwrService.initYwr(initServiceQO);
        ...
        bdcQlrDOList = initLpbToBdcYwrService.initYwr(initServiceQO);
    ...
    public InitServiceQO getInitServiceQO(String sjly,BdcXmDO bdcXmDO){
