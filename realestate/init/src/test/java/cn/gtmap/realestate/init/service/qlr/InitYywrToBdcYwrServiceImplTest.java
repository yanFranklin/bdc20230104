...
import cn.gtmap.realestate.init.service.qlr.impl.InitYywrToBdcYwrServiceImpl;
 ...
 * @description 获取原项目义务人做不动产义务人服务单元测试
 */
...
public class InitYywrToBdcYwrServiceImplTest {
    @Autowired
    private InitYywrToBdcYwrServiceImpl initYywrToBdcYwrService;
    @Autowired
    ...
    public void initQlr(){
        ...
        List<BdcQlrDO> bdcQlrDOList = initYywrToBdcYwrService.initYwr(initServiceQO);
        ...
        bdcQlrDOList = initYywrToBdcYwrService.initYwr(initServiceQO);
