...
public class InitLpbToBdcQtxgqlServiceImplTest {
    @Autowired
    private InitLpbToBdcQtxgqlServiceImpl initLpbToBdcQtxgqlService;
    ...
    public void initQlxx() throws Exception {
        ...
        BdcQtxgqlDO bdcQtxgqlDO = (BdcQtxgqlDO) initLpbToBdcQtxgqlService.initQlxx(initServiceQO);
