...
public class InitLpbToBdcFwzlServiceImplTest {
    @Autowired
    private InitLpbToBdcFwzlServiceImpl initLpbToBdcFwzlService;
    ...
    public void initQlxx() throws Exception {
        ...
        BdcFwzlDO bdcFwzlDO = (BdcFwzlDO) initLpbToBdcFwzlService.initQlxx(initServiceQO);
