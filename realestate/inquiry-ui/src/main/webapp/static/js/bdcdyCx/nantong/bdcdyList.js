...
layui.use(['jquery', 'element', 'form', 'table', 'laydate'], function () {
        ...
        function search() {
            ...
            table.reload("bdcdyTable", {
                ...
                , done: function (res, curr, count) {
                    ...
                    setHeight();
                    //限制状态为锁定，整条显示灰色
                    changeTrBackgroundExceptRight([{name:'bdc-sd',color: '#333', background: '#a7afb6'}]);
    ...
    function detailView(data) {
        window.open('/realestate-register-ui/nantong/djbxx/bdcDjbList.html?param=' + data.bdcdyh);
    ...
    window.viewBdcDjb = function (zsid, zslx) {
        ...
        if ("1" == zslx) {
            window.open("/realestate-register-ui/nantong/zsxx/bdcZs.html?zsid=" + zsid + "&readOnly=false");
        } else if ("2" == zslx) {
            window.open("/realestate-register-ui/nantong/zsxx/bdcZm.html?zsid=" + zsid + "&readOnly=false");
        }
    }
