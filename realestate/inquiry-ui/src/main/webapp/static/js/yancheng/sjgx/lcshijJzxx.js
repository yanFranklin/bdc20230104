...
layui.use(['jquery', 'element', 'form', 'table', 'laydate'], function () {
    ...
    $(function () {
        ...
        $('#search').on('click', function () {
            // 获取查询条件
            var gmsfhm = $(this).parents('.layui-form-item').find('#gmsfhm').val();
            // 判空
        ...
        function search() {
            ...
            if(searchData.cxywcs &&searchData.cxywcs.length >0) {
                for (var i = 0; i < searchData.cxywcs.length; i++) {
                    ...
                    // 重新请求
                    $.ajax({
                        url:"/realestate-inquiry-ui/rest/v1.0/gx/shijgxCx/zhrkkjzxx",
                        type: "POST",
        ...
        $(".upload-pdf").click(function () {
            uploadPdf(gzlslid,"shijzhrkkjzxx","救助信息查询(综合法人库)",key,"市级共享交换平台");
        });
    });
});
