    ...
    $(function () {
        ...
        $('#search').on('click', function () {
            ...
            searchData.push({
                ...
                // "bjry":bjry,
                // "bjrzjh":bjrzjh,
                "certificateType":"shijjk_jzgcjgysbazzxz",
                "gzlslid": gzlslid
            });
        ...
        function search() {
            ...
            if(searchData &&searchData.length >0) {
                for (var i = 0; i < searchData.length; i++) {
                    ...
                    // 重新请求
                    $.ajax({
                        url:"/realestate-inquiry-ui/rest/v1.0/gx/shijgxCx/zzxz/jzgcjgysbazzxz",
                        type: "POST",
                        ...
                        success: function (data) {
                            if (data.success) {
                                ...
                                if (!isNullOrEmpty(data.data)) {
                                    data.data[0].zjh = searchData[0].zjh;
                                    // data.data[0].bjry = searchData[0].bjry;
                                    // data.data[0].bjrzjh = searchData[0].bjrzjh;
