...
(function (obj) {
        ...
        if(data instanceof Array) {
            data.forEach(function (item, index) {
                ...
                selectedSvg = '<svg width="'+ width +'" height="'+height +'" version="1.1" xmlns="http://www.w3.org/2000/svg">'+
                    ...
                    '<rect width="'+width +'" height="'+2*height/5 +'" style="fill:'+nodesImageAttr.color.selectedColor.backgroundColor+';stroke:'+ nodesImageAttr.color.selectedColor.fillColor +'; stroke-width: 5;"/>'+
                    '<text x="20" y="'+ (height/5 -20) +'" font-size="80px" style="fill:#000">'+item.zl1 +'</text>'+
                    '<text x="20" y="'+ (height/4 +40) +'" font-size="80px" style="fill:#000">'+item.zl2 +'</text>'+
                    '<text x="20" y="'+ (height/2 +30) +'" font-size="80px" style="fill:#000">不动产单元号：'+item.bdcdyh +'</text>'+
                    '<text x="20" y="'+ (4*height/5 -10) +'" font-size="80px" style="fill:#000">权利人：'+item.qlr +'</text>'+
                    '<text x="20" y="'+ (height- 25) +'" font-size="80px" style="fill:#000">权利类型：'+item.qllxmc +'</text>'+
                    '</svg>';
                ...
                if(item.qszt ===1) {
                    unselectedSvg = '<svg width="'+ width +'" height="'+height +'" version="1.1" xmlns="http://www.w3.org/2000/svg">'+
                        ...
                        '<rect width="'+width +'" height="'+2*height/5 +'" style="fill:'+nodesImageAttr.color.unselectedColor.nowColor.backgroundColor+';stroke:'+ nodesImageAttr.color.unselectedColor.nowColor.fillColor +'; stroke-width: 5;"/>'+
                        '<text x="20" y="'+ (height/5 -20) +'" font-size="80px" style="fill:#000">'+item.zl1 +'</text>'+
                        '<text x="20" y="'+ (height/4 +40) +'" font-size="80px" style="fill:#000">'+item.zl2 +'</text>'+
                        '<text x="20" y="'+ (height/2 +30) +'" font-size="80px" style="fill:#000">不动产单元号：'+item.bdcdyh +'</text>'+
                        '<text x="20" y="'+ (4*height/5 -10) +'" font-size="80px" style="fill:#000">权利人：'+item.qlr +'</text>'+
                    ...
                    unselectedSvg = '<svg width="'+ width +'" height="'+height +'" version="1.1" xmlns="http://www.w3.org/2000/svg">'+
                        ...
                        '<rect width="'+width +'" height="'+2*height/5 +'" style="fill:'+nodesImageAttr.color.unselectedColor.preColor.backgroundColor +';stroke:'+ nodesImageAttr.color.unselectedColor.preColor.fillColor+'; stroke-width: 5;"/>'+
                        '<text x="20" y="'+ (height/5 -20) +'" font-size="80px" style="fill:#000">'+item.zl1 +'</text>'+
                        '<text x="20" y="'+ (height/4 +40) +'" font-size="80px" style="fill:#000">'+item.zl2 +'</text>'+
                        '<text x="20" y="'+ (height/2 +30) +'" font-size="80px" style="fill:#000">不动产单元号：'+item.bdcdyh +'</text>'+
                        '<text x="20" y="'+ (4*height/5 -10) +'" font-size="80px" style="fill:#000">权利人：'+item.qlr +'</text>'+
                ...
                if(item["yxmidList"].length>0) {
                    var itemFrom = item["yxmidList"];
    ...
    if(typeof define !== "undefined" && typeof define === "function") {
        define("cqbgFlow",[],function(){
            return cqbgFlow;
        });
    }else {
        obj.cqbgFlow = cqbgFlow;
    }
})(window);