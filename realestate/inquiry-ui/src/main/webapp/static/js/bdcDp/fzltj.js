...
// 登记类型统计明细表格查询
var fzltjmxDataUrl = "/realestate-inquiry-ui/rest/v1.0/bdcdp/getFzltjMx";
var fzltbDataUrl = "/realestate-inquiry-ui/rest/v1.0/bdcdp/getFzltjTb";
...
layui.use(['form', 'jquery', 'laydate', 'element', 'table', 'formSelects'], function () {
    ...
    table.render({
        ...
        cols: [[
            ...
            {field: 'bdcdyh', width: 220, sort: true, title: '不动产单元号'},
            {field: 'bdcqzh', width: 220, sort: true, title: '不动产权证号'},
            {field: 'lzr', width: 160, sort: true, title: '领证人'},
            {field: 'qlr', width: 140, sort: true, title: '权利人'},
            {field: 'ywr', width: 140, sort: true, title: '义务人'},
            {field: 'zl', width: 200, sort: true, title: '坐落'},
            {field: 'zslx', width: 140, sort: true, title: '证书类型'},
            {field: 'zmsl', width: 140, sort: true, title: '证明数量'}
        ]],
        autoSort: false,
        page: true,
...
function reloadTjlx() {
    table.reload("pageTableDjlx", {
        ...
        where: {
            ...
            djxl: $("#djxl-select").val(),
            qxdm:$("#qxdm").val(),
            processDefKey: $("#selectLcmc").val(),
