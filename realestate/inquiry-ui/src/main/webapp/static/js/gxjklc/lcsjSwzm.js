        ...
        function search() {
            ...
            if (searchData.cxywcs.length > 0) {
                ...
                for (var paramlength = 0; paramlength < searchData.cxywcs.length; paramlength++) {
                    var param = {
                        "SFZH": searchData.cxywcs[paramlength].zjh
                    };
                    // 重新请求
                    $.ajax({
                        url: "/realestate-inquiry-ui/rest/v1.0/gx/shucheng/bjjk/swzm",
                        type: "POST",
