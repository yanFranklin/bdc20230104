...
layui.use(['jquery', 'element', 'form', 'table', 'laydate'], function () {
    ...
    $(function () {
                ...
                success: function (data) {
                    ...
                    if (data && data.length > 0) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            getData.cxywcs.push({"idcardcord": data[i].zjh,"patientname":data[i].qlrmc});
                            if (data[i].dlrmc && data[i].dlrzjh){
                                getData.cxywcs.push({
                                    "patientname":data[i].dlrmc,
                                    "idcardcord": data[i].dlrzjh
                                });
                            }
                        }
        ...
        $(".upload-pdf").click(function () {
            uploadPdf(gzlslid,"wjwswyxzmjy","省卫健委-死亡医学证明校验",key,"省专线接口");
        });
