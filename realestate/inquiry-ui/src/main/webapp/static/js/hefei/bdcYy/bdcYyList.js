...
layui.use(['table', 'laytpl', 'laydate', 'layer', 'form'], function () {
    ...
    cols=[
        ...
        {field: 'yxtcqzh',title: 'TT系统证号', minWidth: 250},
 ...
 * @return
 */
function exportAllExcel(data, obj,dcts){
    layer.confirm("是否导出全部数据？", {
        title: "提示",
        btn: ["确认", "取消"],
        btn1: function (index) {
            var cols = obj.cols[0]
            var url = obj.url;// /realestate-inquiry-ui/rest/v1.0/bdcYyXx/page
