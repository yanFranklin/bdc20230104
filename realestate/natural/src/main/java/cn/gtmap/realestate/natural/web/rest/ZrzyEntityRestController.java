...
public class ZrzyEntityRestController implements ZrzyEntityRestService {

    /**
     * 日志处理
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(ZrzyEntityRestController.class.getName());
