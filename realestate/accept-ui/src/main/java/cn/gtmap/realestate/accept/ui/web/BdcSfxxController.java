...
//
     ...
     * @description 获取消费交易信息参数
     **/
    @ResponseBody
    @PostMapping("/getXfjyxxcs")
    Object getXfjyxxcs(@RequestParam(value = "gzlslid") String gzlslid, @RequestParam(value = "qlrlb") String qlrlb) {
        if (StringUtils.isAnyBlank(gzlslid, qlrlb)) {
            throw new AppException(ErrorCode.MISSING_ARG, "缺少参数工作流实例ID或权利人类别");
        }
        return bdcSfxxFeignService.getXfjyxxcs(gzlslid, qlrlb);
    }
     ...
     **/
    @ResponseBody
    @PostMapping("/saveJyxx")
    void saveJyxx(@RequestParam(value = "output") String output, @RequestParam(value = "gzlslid") String gzlslid,
                  @RequestParam(value = "qlrlb") String qlrlb) {
        if (StringUtils.isBlank(gzlslid)) {
            throw new AppException(ErrorCode.MISSING_ARG, "缺少参数工作流实例ID");
        }
        if (StringUtils.isBlank(output)) {
            throw new AppException(ErrorCode.MISSING_ARG, "缺少参数pos返回");
        }
        bdcSfxxFeignService.saveJyxx(output, gzlslid, qlrlb);
    }
     ...
     * @author <a href="mailto:xuzhou@gtmap.cn">xuzhou</a>
     * @date 2022/8/22 16:00
     * @description 广开聚合支付交易参数
     **/
    @ResponseBody
    @PostMapping("/gkjhZfJyCs")
    Object gkjhZfJyCs(@RequestParam(value = "gzlslid") String gzlslid,
                      @RequestParam(value = "qlrlb") String qlrlb,
                      @RequestParam(value = "fkm") String fkm) {
        if (StringUtils.isAnyBlank(gzlslid, qlrlb, fkm)) {
            throw new AppException(ErrorCode.MISSING_ARG, "缺少参数工作流实例ID、权利人类别或付款方");
        }
        return bdcSfxxFeignService.gkjhZfJyCs(gzlslid, qlrlb, fkm);
    }
     ...
     * @description 当日撤销交易参数
     **/
    @ResponseBody
    @PostMapping("/drcxjyCs")
    Object drcxjyCs(@RequestParam(value = "gzlslid") String gzlslid, @RequestParam(value = "qlrlb") String qlrlb) {
        if (StringUtils.isAnyBlank(gzlslid, qlrlb)) {
            throw new AppException(ErrorCode.MISSING_ARG, "缺少参数工作流实例ID或权利人类别");
        }
        return bdcSfxxFeignService.drcxjyCs(gzlslid, qlrlb);
    }
    ...
    @ResponseBody
    @PostMapping("/tkjyCs")
    Object thjyCs(@RequestParam(value = "gzlslid") String gzlslid, @RequestParam(value = "qlrlb") String qlrlb) {
        return bdcSfxxFeignService.thjyCs(gzlslid, qlrlb);
    }
     ...
     * @author <a href="mailto:xuzhou@gtmap.cn">xuzhou</a>
     * @date 2022/8/22 16:02
     * @description 广开聚合退货交易参数
     **/
    @ResponseBody
    @PostMapping("/gkjhthjyCs")
    Object gkjhthjyCs(@RequestParam(value = "gzlslid") String gzlslid, @RequestParam(value = "qlrlb") String qlrlb) {
        return bdcSfxxFeignService.gkjhthjyCs(gzlslid, qlrlb);
    }
     ...
     **/
    @ResponseBody
    @PostMapping("/rePrintJyCs")
    Object rePrintJyCs(@RequestParam(value = "gzlslid") String gzlslid, @RequestParam(value = "qlrlb") String qlrlb) {
        return bdcSfxxFeignService.rePrintJyCs(gzlslid, qlrlb);
    }
