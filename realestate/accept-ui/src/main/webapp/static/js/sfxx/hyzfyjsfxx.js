...
layui.use(['form', 'jquery', 'laydate', 'element', 'table', 'formSelects'], function () {
    ...
    $(function () {
        ...
        getReturnData("/rest/v1.0/yjsfxx/hyzfjftj/config",{},"GET",function (data) {
            if(isNotBlank(data)){
                hyzfjftj = data;
            }
        },function () {
        ...
        function smxd(checkData, cols){
            ...
            if(checkedPay(checkData)){
                console.info("checkedPay finish");
        ...
        function scdd(yjdh){
            layer.open({
                ...
                area: ['450px', '200px'],
                btn: ['确定'],
                content: $('#bdc-popup-hyzfjftj'),
                yes: function (index, layero) {
                    var hyzfjftj = $("input[name='hyzfjftj']:checked").val();
                    if(!isNotBlank(hyzfjftj)){
                        ityzl_SHOW_WARN_LAYER("请选择缴费途径");
                        return;
                    }
                    layer.close(index);
                    addModel();
                    getReturnData("/rest/v1.0/yjsfxx/scdd",{yjdh: yjdh, hyzfjftj: hyzfjftj},"GET",function (data) {
                        removeModal();
                ...
                success: function(){
                    if(isNotBlank(hyzfjftj)){
                        $("input[type='radio'][name='hyzfjftj'][value='"+hyzfjftj+"']").attr("checked",true);
                        form.render();
                    }
                }
            });
