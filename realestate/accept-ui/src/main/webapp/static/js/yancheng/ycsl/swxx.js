    ...
    $(function () {
            ...
            getReturnData("/slym/xm/listBdcXm", {gzlslid: processInsId}, 'GET', function (xmxxList) {
                if(xmxxList &&xmxxList.length >0) {
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        async: false,
                        data: {gzlslid: processInsId, xmid: xmid,hsxxlx:1},
                        success: function (data) {
                            //测试数据
                            //data.bdcZrfSwxxList={ "bdcSlHsxxDO":{"sjbh":"12343234","htbh":"ht12314414","wsfs":"01"},"bdcSlHsxxMxDOList":[{"fjlx":"1001","fjid":"21212"},{"fjlx":"1002","fjid":"212313"},{"fjlx":"1003","fjid":"212313"}]};
                            //console.log(data.bdcZrfSwxxList[0]);
                            var bdcZrfSwxx;
        ...
        function getSwxx (htbh,nsrsbh){
            $.ajax({
                ...
                dataType: 'json',
                async: false,
                data: {xmid: xmid, slbh: slbh, gzlslid: processInsId, gxlx:"1", htbh:htbh, nsrsbh:nsrsbh, beanName:"sw_qswspzhq"},
                success: function (data) {
                    removeModal();
                    if(data){
                        var swxx =data;
        ...
        function drSwxx(data) {
            ...
            var swxx =data;
            $.ajax({
                url: getContextPath() + "/slym/sw/saveQswspzResponse?xmid=" + xmid + "&gxlx=1",
                type: "POST",
