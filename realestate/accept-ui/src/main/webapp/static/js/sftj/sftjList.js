...
$(function () {
    ...
    layui.use(['form', 'table', 'jquery'], function () {
        ...
        var url = getContextPath() + '/sf/listsftjbypage';
        ...
        table.on('tool(sfxxTable)', function (obj) {
            ...
            layer.open({
                ...
                area: ['100%', '100%'],
                resize: true,
                content: getContextPath() + '/view/sftj/sftj.html?xmid=' + data.xmid + "&formStateId=" + formStateId + "&readOnly=" + readOnly + "&processInsId=" + processInsId + "&djxl=" + data.djxl + "&sfymlx=" + sfymlx
            });
