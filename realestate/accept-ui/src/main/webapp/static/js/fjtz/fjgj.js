var wjzxid = getQueryString("wjzxid");
...
layui.use(['element', 'form', 'jquery', 'tree', 'layer'], function () {
    ...
    $(function () {
        ...
        setTimeout(function () {
            try {
                $.when(getDkFj(),getDqlcFj()).done(function () {
    ...
    function getDqlcFj(){
        $.ajax({
            url: "/realestate-inquiry-ui/fjtz/fj/current/list/"+processInsId,
            type: 'GET',
    ...
    function getDkFj(){
        $.ajax({
            url: "/realestate-inquiry-ui/fjtz/fj/list/"+wjzxid,
            type: 'GET',
            async: false,
            success: function (data) {
                console.log("地块附件材料为：");
    ...
    function saveFj(){
        ...
        $.ajax({
            url: "/realestate-inquiry-ui/fjtz/fj/save/"+processInsId,
            type: 'POST',
            dataType: 'json',
