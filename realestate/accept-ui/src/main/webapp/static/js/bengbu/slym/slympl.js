...
function openPlxg(xmids) {
    ...
    var index = layer.open({
        ...
        fixed: false, //不固定
        maxmin: true, //开启最大化最小化按钮
        content: getContextPath() + "/bengbu/slym/plxg.html?processInsId=" + processInsId + "&xmid=" + xmid + "&formStateId=" + formStateId + "&zxlc=" + zxlc + "&sfdydj=" + sfdydj,
        cancel: function () {
...
function getQlCols() {
    ...
    if (qllx === 4 || qllx === 6 || qllx === 8) {
        ...
        cols = [
            ...
            {field: 'myzcs', title: '名义总层数', minWidth: 100},
...
function addQlr(qllx, elem) {
    ...
    layui.use(['form', 'jquery', 'laytpl', 'element', 'laydate'], function () {
        var form = layui.form;
        var url = getContextPath() + "/view/slym/qlr.html?xmid=" + xmid + "&djxl=" + djxl + "&lclx=" + lclx + "&processInsId=" + processInsId + "&formStateId=" + formStateId + "&qllx=" + qllx + "&zxlc=" + zxlc;
        if (dydj) {
            url = url + "&dydj=true";
        }
        layer.open({
...
function showQlr(qlrid, xmid, qlrlb, elem) {
    ...
    layui.use(['form', 'jquery', 'laytpl', 'element', 'laydate'], function () {
        var form = layui.form;
        var url = getContextPath() + "/view/slym/qlr.html?processInsId=" + processInsId + "&djxl=" + djxl + "&qlrid=" + qlrid + "&lclx=" + lclx + "&xmid=" + xmid + "&formStateId=" + formStateId + "&qllx=" + qllx + "&readOnly=" + readOnly + "&zxlc=" + zxlc;
        //标题
        var title;
        if (dydj) {
            url = url + "&dydj=true";
...
function showYwr(qlrid, xmid, qlrlb, otherqlridList, otherXmidList) {
    ...
    layui.use(['form', 'jquery', 'laytpl', 'element', 'laydate'], function () {
        var form = layui.form;
        var url = getContextPath() + "/view/slym/qlr.html?processInsId=" + processInsId + "&qlrid=" + qlrid + "&djxl=" + djxl + "&lclx=" + lclx + "&xmid=" + xmid + "&formStateId=" + formStateId + "&qllx=" + qllx + "&readOnly=" + readOnly + "&zxlc=" + zxlc;
        //标题
        var title;
        if (dydj) {
            url = url + "&dydj=true";
